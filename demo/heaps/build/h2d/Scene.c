...
h2d__Camera h2d_Scene_set_interactiveCamera(h2d__Scene r0,h2d__Camera r1) {
	...
	vdynamic *r5;
	h2d__Scene r4;
	if( r1 ) goto label$d33faab_2_3;
	r3 = (String)s$a7cc641;
	hl_throw((vdynamic*)r3);
	label$d33faab_2_3:
	if( r1 == NULL ) hl_null_access();
	r4 = r1->scene;
	if( r4 == r0 ) goto label$d33faab_2_8;
	r5 = NULL;
	h2d_Scene_addCamera(r0,r1,r5);
	label$d33faab_2_8:
...
void h2d_Scene_removeCamera(h2d__Scene r0,h2d__Camera r1) {
	...
	if( r1 != r3 ) goto label$d33faab_4_4;
	r4 = (String)s$d97a1d0;
...
void h2d_Scene_checkResize(h2d__Scene r0) {
	...
	switch(r5) {
		...
		case 0:
			...
			r8 = r0->width;
			if( r5 != r8 ) goto label$d33faab_5_17;
			r8 = r0->height;
			if( r6 == r8 ) goto label$d33faab_5_21;
			label$d33faab_5_17:
			r0->width = r5;
			r0->height = r6;
			r9 = true;
		...
		case 1:
			...
			if( r0 == NULL ) hl_null_access();
			r8 = r0->width;
			if( r5 != r8 ) goto label$d33faab_5_47;
			r8 = r0->height;
			if( r6 == r8 ) goto label$d33faab_5_51;
			label$d33faab_5_47:
			r0->width = r5;
			r0->height = r6;
			r9 = true;
		...
		case 2:
			...
			if( r0 == NULL ) hl_null_access();
			r8 = r0->width;
			if( r5 != r8 ) goto label$d33faab_5_87;
			r8 = r0->height;
			if( r6 == r8 ) goto label$d33faab_5_91;
			label$d33faab_5_87:
			r0->width = r5;
			r0->height = r6;
			r9 = true;
			...
			r15 = (double)r6;
			r11 = r11 / r15;
			if( !(r11 < r10) ) goto label$d33faab_5_103;
			r15 = r11;
			goto label$d33faab_5_104;
			label$d33faab_5_103:
			r15 = r10;
			label$d33faab_5_104:
			r9 = r12 ? r12->v.b : 0;
			if( !r9 ) goto label$d33faab_5_113;
			r7 = (int)r15;
			r16 = (double)r7;
			r15 = r16;
			r17 = 0.;
			if( r16 != r17 ) goto label$d33faab_5_113;
			r16 = 1.;
			r15 = r16;
			label$d33faab_5_113:
			r18 = r13;
			...
			if( r13 ) goto label$d33faab_5_132;
			...
			label$d33faab_5_182:
			if( r14 ) goto label$d33faab_5_185;
			r20 = (venum*)g$h2d_ScaleModeAlign_Center;
			r19 = r20;
			label$d33faab_5_185:
		...
		case 3:
			...
			if( r0 == NULL ) hl_null_access();
			r8 = r0->width;
			if( r5 != r8 ) goto label$d33faab_5_246;
			r8 = r0->height;
			if( r6 == r8 ) goto label$d33faab_5_250;
			label$d33faab_5_246:
			r0->width = r5;
			r0->height = r6;
			r9 = true;
			...
			r0->viewportScaleX = r10;
			r0->viewportScaleY = r10;
			if( r13 ) goto label$d33faab_5_270;
			r20 = (venum*)g$h2d_ScaleModeAlign_Center;
			r18 = r20;
			label$d33faab_5_270:
			if( r18 == NULL ) hl_null_access();
			...
			label$d33faab_5_320:
			if( r14 ) goto label$d33faab_5_323;
			r20 = (venum*)g$h2d_ScaleModeAlign_Center;
			r19 = r20;
			label$d33faab_5_323:
			if( r19 == NULL ) hl_null_access();
		...
		case 4:
			...
			if( r0 == NULL ) hl_null_access();
			r8 = r0->width;
			if( r5 != r8 ) goto label$d33faab_5_389;
			r8 = r0->height;
			if( r6 == r8 ) goto label$d33faab_5_393;
			label$d33faab_5_389:
			r0->width = r5;
			r0->height = r6;
			r9 = true;
		...
		case 5:
			...
			r15 = (double)r6;
			r11 = r11 / r15;
			if( !(r11 < r10) ) goto label$d33faab_5_425;
			r15 = r11;
			goto label$d33faab_5_426;
			label$d33faab_5_425:
			r15 = r10;
			label$d33faab_5_426:
			r9 = r12 ? r12->v.b : 0;
			if( !r9 ) goto label$d33faab_5_435;
			r7 = (int)r15;
			r16 = (double)r7;
			r15 = r16;
			r17 = 0.;
			if( r16 != r17 ) goto label$d33faab_5_435;
			r16 = 1.;
			r15 = r16;
			label$d33faab_5_435:
			r7 = r2->width;
			...
			if( r0 == NULL ) hl_null_access();
			r22 = r0->width;
			if( r7 != r22 ) goto label$d33faab_5_448;
			r22 = r0->height;
			if( r8 == r22 ) goto label$d33faab_5_452;
			label$d33faab_5_448:
			r0->width = r7;
			r0->height = r8;
			r9 = true;
...
void h2d_Scene_dispatchListeners(h2d__Scene r0,hxd__Event r1) {
	...
	if( r4 == NULL ) hl_null_access();
	r5 = r4->length;
	if( r3 >= r5 ) goto label$d33faab_6_22;
	r5 = r4->length;
	if( ((unsigned)r3) < ((unsigned)r5) ) goto label$d33faab_6_11;
	r6 = NULL;
	goto label$d33faab_6_14;
	label$d33faab_6_11:
	r8 = r4->array;
	r7 = ((vdynamic**)(r8 + 1))[r3];
	r6 = (vclosure*)r7;
	...
	if( r1 == NULL ) hl_null_access();
	r9 = r1->propagate;
	if( r9 ) goto label$d33faab_6_21;
	goto label$d33faab_6_22;
	label$d33faab_6_21:
	goto label$d33faab_6_3;
	label$d33faab_6_22:
	return;
}
...
bool h2d_Scene_isInteractiveVisible(h2d__Scene r0,vvirtual* r1) {
	...
	label$d33faab_7_1:
	if( r2 == ((h2d__Object)r0) ) goto label$d33faab_7_12;
	if( !r2 ) goto label$d33faab_7_7;
	if( r2 == NULL ) hl_null_access();
	r4 = r2->visible;
	if( r4 ) goto label$d33faab_7_9;
	label$d33faab_7_7:
	r4 = false;
	return r4;
	label$d33faab_7_9:
...
vvirtual* h2d_Scene_handleEvent(h2d__Scene r0,hxd__Event r1,vvirtual* r2) {
	...
	bool r25, r28;
	h2d__Object r26, r27;
	h2d__col__Collider r24;
	double r4, r5, r18, r19, r20, r21, r22, r23;
	h2d__col__PointImpl r12;
	vdynamic *r10, *r16;
	h2d__Interactive r9;
	varray *r17;
	...
	r4 = r1->relX;
	r5 = r1->relY;
	if( r2 ) goto label$d33faab_10_7;
	r6 = 0;
	goto label$d33faab_10_14;
	label$d33faab_10_7:
	r8 = r0->interactive;
	...
	r13 = r8->length;
	label$d33faab_10_19:
	if( r11 >= r13 ) goto label$d33faab_10_116;
	r14 = r11;
	++r11;
	r8 = r0->interactive;
	if( r8 == NULL ) hl_null_access();
	r15 = r8->length;
	if( ((unsigned)r14) < ((unsigned)r15) ) goto label$d33faab_10_29;
	r9 = NULL;
	goto label$d33faab_10_32;
	label$d33faab_10_29:
	r17 = r8->array;
	r16 = ((vdynamic**)(r17 + 1))[r14];
	r9 = (h2d__Interactive)r16;
	label$d33faab_10_32:
	if( r9 ) goto label$d33faab_10_34;
	goto label$d33faab_10_116;
	label$d33faab_10_34:
	if( r9 == NULL ) hl_null_access();
	r18 = r9->invDet;
	r19 = 0.;
	if( r18 != r19 ) goto label$d33faab_10_39;
	goto label$d33faab_10_19;
	label$d33faab_10_39:
	r19 = r9->absX;
	r18 = r4 - r19;
	r20 = r9->absY;
	...
	r21 = r21 * r22;
	r24 = r9->shape;
	if( !r24 ) goto label$d33faab_10_72;
	...
	r25 = ((bool (*)(h2d__col__Collider,h2d__col__PointImpl))r24->$type->vobj_proto[0])(r24,r12);
	if( r25 ) goto label$d33faab_10_71;
	goto label$d33faab_10_19;
	label$d33faab_10_71:
	goto label$d33faab_10_81;
	label$d33faab_10_72:
	r23 = 0.;
	if( r21 < r23 ) goto label$d33faab_10_80;
	r23 = 0.;
	if( r20 < r23 ) goto label$d33faab_10_80;
	r23 = r9->width;
	if( r20 >= r23 ) goto label$d33faab_10_80;
	r23 = r9->height;
	if( !(r21 >= r23) ) goto label$d33faab_10_81;
	label$d33faab_10_80:
	goto label$d33faab_10_19;
	label$d33faab_10_81:
	r25 = true;
	r26 = ((h2d__Object)r9);
	label$d33faab_10_83:
	if( !r26 ) goto label$d33faab_10_94;
	if( r26 == NULL ) hl_null_access();
	r28 = r26->visible;
	if( r28 ) goto label$d33faab_10_91;
	r28 = false;
	r25 = r28;
	goto label$d33faab_10_94;
	label$d33faab_10_91:
	r27 = r26->parent;
	r26 = r27;
	goto label$d33faab_10_83;
	label$d33faab_10_94:
	if( r25 ) goto label$d33faab_10_96;
	goto label$d33faab_10_19;
	label$d33faab_10_96:
	if( r1 == NULL ) hl_null_access();
	r1->relX = r20;
	...
	r28 = r1->cancel;
	if( !r28 ) goto label$d33faab_10_108;
	r28 = false;
	r1->cancel = r28;
	r28 = false;
	r1->propagate = r28;
	goto label$d33faab_10_19;
	label$d33faab_10_108:
	if( r9 ) goto label$d33faab_10_111;
	r7 = NULL;
	goto label$d33faab_10_115;
	label$d33faab_10_111:
	r7 = r9->f$52;
	if( r7 ) goto label$d33faab_10_115;
	r7 = hl_to_virtual(&t$vrt_c8e313e,(vdynamic*)r9);
	r9->f$52 = r7;
	label$d33faab_10_115:
	return r7;
	label$d33faab_10_116:
	r7 = NULL;
	return r7;
}
...
void h2d_Scene_addEventTarget(h2d__Scene r0,h2d__Interactive r1) {
	...
	r5 = 0;
	label$d33faab_11_2:
	if( !r3 ) goto label$d33faab_11_9;
	if( r3 == NULL ) hl_null_access();
	r6 = r3->parent;
	r3 = r6;
	++r5;
	goto label$d33faab_11_2;
	label$d33faab_11_9:
	r7 = r5;
	r8 = 0;
	r10 = r0->interactive;
	...
	r9 = r10->length;
	label$d33faab_11_14:
	if( r8 >= r9 ) goto label$d33faab_11_124;
	r11 = r8;
	++r8;
	r6 = ((h2d__Object)r1);
	r10 = r0->interactive;
	if( r10 == NULL ) hl_null_access();
	r13 = r10->length;
	if( ((unsigned)r11) < ((unsigned)r13) ) goto label$d33faab_11_25;
	r2 = NULL;
	goto label$d33faab_11_28;
	label$d33faab_11_25:
	r15 = r10->array;
	...
	r13 = 0;
	label$d33faab_11_32:
	if( !r17 ) goto label$d33faab_11_39;
	if( r17 == NULL ) hl_null_access();
	r18 = r17->parent;
	r17 = r18;
	++r13;
	goto label$d33faab_11_32;
	label$d33faab_11_39:
	r19 = r13;
	r18 = r6;
	r20 = r16;
	label$d33faab_11_42:
	if( r19 >= r12 ) goto label$d33faab_11_50;
	r6 = r18;
	if( r18 == NULL ) hl_null_access();
	r23 = r18->parent;
	r18 = r23;
	--r12;
	goto label$d33faab_11_42;
	label$d33faab_11_50:
	if( r12 >= r19 ) goto label$d33faab_11_58;
	r16 = r20;
	if( r20 == NULL ) hl_null_access();
	r23 = r20->parent;
	r20 = r23;
	--r19;
	goto label$d33faab_11_50;
	label$d33faab_11_58:
	if( r18 == r20 ) goto label$d33faab_11_69;
	r6 = r18;
	if( r18 == NULL ) hl_null_access();
	r23 = r18->parent;
	r18 = r23;
	...
	r24 = r10->length;
	label$d33faab_11_75:
	if( r22 >= r24 ) goto label$d33faab_11_93;
	r25 = r22;
	++r22;
	if( r18 == NULL ) hl_null_access();
	r10 = r18->children;
	if( r10 == NULL ) hl_null_access();
	r27 = r10->length;
	if( ((unsigned)r25) < ((unsigned)r27) ) goto label$d33faab_11_86;
	r23 = NULL;
	goto label$d33faab_11_89;
	label$d33faab_11_86:
	r15 = r10->array;
	r14 = ((vdynamic**)(r15 + 1))[r25];
	r23 = (h2d__Object)r14;
	label$d33faab_11_89:
	if( r23 != r6 ) goto label$d33faab_11_92;
	r21 = r25;
	goto label$d33faab_11_93;
	label$d33faab_11_92:
	goto label$d33faab_11_75;
	label$d33faab_11_93:
	r22 = r21;
	r24 = -1;
	r25 = 0;
	...
	if( r10 == NULL ) hl_null_access();
	r26 = r10->length;
	label$d33faab_11_100:
	if( r25 >= r26 ) goto label$d33faab_11_118;
	r27 = r25;
	++r25;
	if( r20 == NULL ) hl_null_access();
	r10 = r20->children;
	if( r10 == NULL ) hl_null_access();
	r28 = r10->length;
	if( ((unsigned)r27) < ((unsigned)r28) ) goto label$d33faab_11_111;
	r23 = NULL;
	goto label$d33faab_11_114;
	label$d33faab_11_111:
	r15 = r10->array;
	r14 = ((vdynamic**)(r15 + 1))[r27];
	r23 = (h2d__Object)r14;
	label$d33faab_11_114:
	if( r23 != r16 ) goto label$d33faab_11_117;
	r24 = r27;
	goto label$d33faab_11_118;
	label$d33faab_11_117:
	goto label$d33faab_11_100;
	label$d33faab_11_118:
	if( r24 >= r22 ) goto label$d33faab_11_123;
	r10 = r0->interactive;
	if( r10 == NULL ) hl_null_access();
	hl_types_ArrayObj_insert(r10,r11,((vdynamic*)r1));
	return;
	label$d33faab_11_123:
	goto label$d33faab_11_14;
	label$d33faab_11_124:
	r10 = r0->interactive;
	if( r10 == NULL ) hl_null_access();
...
void h2d_Scene_removeEventTarget(h2d__Scene r0,h2d__Interactive r1,bool* r2) {
	...
	bool r3, r4;
	hxd__SceneEvents r7;
	if( r2 ) goto label$d33faab_12_3;
	r3 = false;
	goto label$d33faab_12_4;
	label$d33faab_12_3:
	r3 = *r2;
	label$d33faab_12_4:
	r5 = r0->interactive;
	...
	if( !r3 ) goto label$d33faab_12_20;
	r7 = r0->events;
	if( !r7 ) goto label$d33faab_12_20;
	r7 = r0->events;
	if( r7 == NULL ) hl_null_access();
	if( r1 ) goto label$d33faab_12_15;
	r8 = NULL;
	goto label$d33faab_12_19;
	label$d33faab_12_15:
	r8 = r1->f$52;
	if( r8 ) goto label$d33faab_12_19;
...
void h2d_Scene_render(h2d__Scene r0,h3d__Engine r1) {
	...
	r3 = r9->length;
	r4 = 0;
	if( r3 != r4 ) goto label$d33faab_14_28;
	return;
	label$d33faab_14_28:
	r2 = r0->ctx;
	if( r2 == NULL ) hl_null_access();
...
void h2d_Scene_sync(h2d__Scene r0,h2d__RenderContext r1) {
	...
	if( r6 == NULL ) hl_null_access();
	r7 = r6->length;
	if( r5 >= r7 ) goto label$d33faab_15_24;
	r7 = r6->length;
	if( ((unsigned)r5) < ((unsigned)r7) ) goto label$d33faab_15_15;
	r8 = NULL;
	goto label$d33faab_15_18;
	label$d33faab_15_15:
	r10 = r6->array;
	...
	goto label$d33faab_15_7;
	label$d33faab_15_24:
	return;
}

void h2d_Scene_clipBounds(h2d__Scene r0,h2d__RenderContext r1,h2d__col__Bounds r2,double* r3,double* r4) {
	h3d__VectorImpl r9, r11;
	vvirtual *r8;
	h3d__shader__Base2d r10;
	double r5, r6, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26;
	if( r3 ) goto label$d33faab_16_3;
	r5 = 1.;
	goto label$d33faab_16_4;
	label$d33faab_16_3:
	r5 = *r3;
	label$d33faab_16_4:
	if( r4 ) goto label$d33faab_16_7;
	r6 = 1.;
	goto label$d33faab_16_8;
	label$d33faab_16_7:
	r6 = *r4;
	label$d33faab_16_8:
	if( r1 == NULL ) hl_null_access();
	r8 = r1->inFilter;
	if( !r8 ) goto label$d33faab_16_110;
	r10 = r1->baseShader;
	if( r10 == NULL ) hl_null_access();
	r9 = r10->filterMatrixA__;
	r10 = r1->baseShader;
	if( r10 == NULL ) hl_null_access();
	r11 = r10->filterMatrixB__;
	r12 = r0->matA;
	if( r9 == NULL ) hl_null_access();
	r13 = r9->x;
	r12 = r12 * r13;
	...
	r24 = r24 + r25;
	r23 = r24;
	goto label$d33faab_16_166;
	label$d33faab_16_110:
	r12 = r0->matA;
	r13 = r1->viewA;
	r12 = r12 * r13;
	r13 = r0->matB;
...
void h2d_Scene_drawContent(h2d__Scene r0,h2d__RenderContext r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r3 = r1->front2back;
	if( !r3 ) goto label$d33faab_17_78;
	r4 = 0;
	r5 = r0->_cameras;
	label$d33faab_17_5:
	if( r5 == NULL ) hl_null_access();
	r7 = r5->length;
	if( r4 >= r7 ) goto label$d33faab_17_76;
	r7 = r5->length;
	if( ((unsigned)r4) < ((unsigned)r7) ) goto label$d33faab_17_13;
	r9 = NULL;
	goto label$d33faab_17_16;
	label$d33faab_17_13:
	r11 = r5->array;
	...
	if( r9 == NULL ) hl_null_access();
	r3 = r9->visible;
	if( r3 ) goto label$d33faab_17_21;
	goto label$d33faab_17_5;
	label$d33faab_17_21:
	r8 = r0->children;
	if( r8 == NULL ) hl_null_access();
	r6 = r8->length;
	...
	--r7;
	r13 = 0;
	if( r13 >= r12 ) goto label$d33faab_17_73;
	r13 = 0;
	if( r7 != r13 ) goto label$d33faab_17_35;
	r12 = 0;
	goto label$d33faab_17_47;
	label$d33faab_17_35:
	...
	r12 = r7 - r13;
	r13 = r14->length;
	if( ((unsigned)r12) < ((unsigned)r13) ) goto label$d33faab_17_43;
	r12 = 0;
	goto label$d33faab_17_47;
	label$d33faab_17_43:
	r15 = r14->bytes;
	...
	if( !r3 ) goto label$d33faab_17_69;
	label$d33faab_17_52:
	if( r6 < r12 ) goto label$d33faab_17_68;
	r8 = r0->children;
	if( r8 == NULL ) hl_null_access();
	r13 = r6;
	--r6;
	r17 = r8->length;
	if( ((unsigned)r13) < ((unsigned)r17) ) goto label$d33faab_17_62;
	r18 = NULL;
	goto label$d33faab_17_65;
	label$d33faab_17_62:
	r11 = r8->array;
	...
	label$d33faab_17_65:
	if( r18 == NULL ) hl_null_access();
	h2d_Object_drawRec(r18,r1);
	goto label$d33faab_17_52;
	label$d33faab_17_68:
	goto label$d33faab_17_72;
	label$d33faab_17_69:
	r17 = 1;
	r13 = r12 - r17;
	r6 = r13;
	label$d33faab_17_72:
	goto label$d33faab_17_26;
	label$d33faab_17_73:
	if( r9 == NULL ) hl_null_access();
	...
	if( r5 == NULL ) hl_null_access();
	r7 = r5->length;
	if( r4 >= r7 ) goto label$d33faab_17_144;
	r7 = r5->length;
	if( ((unsigned)r4) < ((unsigned)r7) ) goto label$d33faab_17_89;
	r9 = NULL;
	goto label$d33faab_17_92;
	label$d33faab_17_89:
	r11 = r5->array;
	r10 = ((vdynamic**)(r11 + 1))[r4];
	r9 = (h2d__Camera)r10;
	...
	if( r9 == NULL ) hl_null_access();
	r3 = r9->visible;
	if( r3 ) goto label$d33faab_17_97;
	goto label$d33faab_17_81;
	label$d33faab_17_97:
	r6 = 0;
	r7 = 0;
	h2d_Camera_enter(r9,r1);
	label$d33faab_17_100:
	r13 = r0->layerCount;
	if( r7 >= r13 ) goto label$d33faab_17_141;
	r14 = r0->layersIndexes;
	if( r14 == NULL ) hl_null_access();
	r12 = r7;
	++r7;
	r13 = r14->length;
	if( ((unsigned)r12) < ((unsigned)r13) ) goto label$d33faab_17_111;
	r12 = 0;
	goto label$d33faab_17_115;
	label$d33faab_17_111:
	r15 = r14->bytes;
	r13 = 2;
	r13 = r12 << r13;
	r12 = *(int*)(r15 + r13);
	label$d33faab_17_115:
	if( r9 == NULL ) hl_null_access();
	r16 = r9->layerVisible;
	if( r16 == NULL ) hl_null_access();
	r17 = 1;
	...
	if( !r3 ) goto label$d33faab_17_139;
	label$d33faab_17_122:
	if( r6 >= r12 ) goto label$d33faab_17_138;
	r8 = r0->children;
	if( r8 == NULL ) hl_null_access();
	r13 = r6;
	++r6;
	r17 = r8->length;
	if( ((unsigned)r13) < ((unsigned)r17) ) goto label$d33faab_17_132;
	r18 = NULL;
	goto label$d33faab_17_135;
	label$d33faab_17_132:
	r11 = r8->array;
	r10 = ((vdynamic**)(r11 + 1))[r13];
	r18 = (h2d__Object)r10;
	label$d33faab_17_135:
	if( r18 == NULL ) hl_null_access();
	h2d_Object_drawRec(r18,r1);
	goto label$d33faab_17_122;
	label$d33faab_17_138:
	goto label$d33faab_17_140;
	label$d33faab_17_139:
	r6 = r12;
	label$d33faab_17_140:
	goto label$d33faab_17_100;
	label$d33faab_17_141:
	if( r9 == NULL ) hl_null_access();
	h2d_Camera_exit(r9,r1);
	goto label$d33faab_17_81;
	label$d33faab_17_144:
	return;
}
...
void h2d_Scene_new(h2d__Scene r0) {
	...
	r10 = 0;
	r12 = r7->length;
	if( ((unsigned)r10) < ((unsigned)r12) ) goto label$d33faab_20_23;
	r11 = NULL;
	goto label$d33faab_20_26;
	label$d33faab_20_23:
	r8 = r7->array;
	...
	r16 = (h2d__col__PointImpl)hl_alloc_obj(&t$h2d_col_PointImpl);
	r14 = 0.;
	r17 = &r14;
	r15 = 0.;
	r18 = &r15;
	h2d_col_PointImpl_new(r16,r17,r18);
	r0->shapePoint = r16;
