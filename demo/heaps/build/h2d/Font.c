...
double h2d_Font_calcBaseLine(h2d__Font r0) {
	haxe__ds__IntMap r3;
	h2d__Tile r8;
	h2d__FontChar r5, r6, r10;
	double r1, r7, r9;
	vdynamic *r2;
	int r4;
	r1 = 0.;
	...
	r2 = haxe_ds_IntMap_get(r3,r4);
	r6 = (h2d__FontChar)r2;
	if( r6 ) goto label$efd1f54_2_26;
	r3 = r0->glyphs;
	if( r3 == NULL ) hl_null_access();
	r4 = 97;
	r2 = haxe_ds_IntMap_get(r3,r4);
	r10 = (h2d__FontChar)r2;
	r6 = r10;
	label$efd1f54_2_26:
	if( r6 ) goto label$efd1f54_2_33;
	r3 = r0->glyphs;
	if( r3 == NULL ) hl_null_access();
	r4 = 48;
	r2 = haxe_ds_IntMap_get(r3,r4);
