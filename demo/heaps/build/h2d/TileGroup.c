...
void h2d_TileGroup_new(h2d__TileGroup r0,h2d__Tile r1,h2d__Object r2) {
	...
	r0->rangeMax = r4;
	r0->rangeMin = r4;
	r5 = (h3d__Vector4Impl)hl_alloc_obj(&t$h3d_Vector4Impl);
	r4 = 1;
	r6 = (double)r4;
	r7 = &r6;
	r4 = 1;
	...
	r12 = (double)r4;
	r13 = &r12;
	h3d_Vector4Impl_new(r5,r7,r9,r11,r13);
	r0->curColor = r5;
...
void h2d_TileGroup_sync(h2d__TileGroup r0,h2d__RenderContext r1) {
	...
	r3 = r0->visible;
	if( !r3 ) goto label$daf1523_6_14;
	r4 = r0->content;
	if( r4 == NULL ) hl_null_access();
	r5 = r4->buffer;
	if( !r5 ) goto label$daf1523_6_11;
	r5 = r4->buffer;
	if( r5 == NULL ) hl_null_access();
	r6 = r5->vbuf;
	if( r6 ) goto label$daf1523_6_14;
	label$daf1523_6_11:
	r8 = (h3d__$Engine)g$_h3d_Engine;
	r7 = r8->CURRENT;
	h2d_TileLayerContent_alloc(r4,r7);
	label$daf1523_6_14:
	return;
}

void h2d_TileGroup_drawWith(h2d__TileGroup r0,h2d__RenderContext r1,h2d__Drawable r2) {
	h2d__impl__BatchDrawState r15;
	h2d__TileLayerContent r4;
	bool r8;
	h3d__Engine r13;
	h3d__$Engine r14;
	...
	r7 = 0;
	if( r3 != r7 ) goto label$daf1523_7_6;
	return;
	label$daf1523_7_6:
	if( r1 == NULL ) hl_null_access();
	r8 = h2d_RenderContext_beginDrawBatchState(r1,r2);
	if( r8 ) goto label$daf1523_7_10;
	return;
	label$daf1523_7_10:
	r6 = r0->rangeMin;
	r7 = 0;
	if( r6 >= r7 ) goto label$daf1523_7_15;
	r6 = 0;
	...
	r7 = r0->rangeMax;
	r9 = 0;
	if( r9 >= r7 ) goto label$daf1523_7_29;
	r7 = r0->rangeMax;
	r10 = 2;
	r9 = r3 * r10;
	if( r7 >= r9 ) goto label$daf1523_7_29;
	r7 = r0->rangeMax;
	r9 = 2;
	r7 = r7 * r9;
	r3 = r7;
	...
	if( r4 == NULL ) hl_null_access();
	r11 = r4->buffer;
	if( !r11 ) goto label$daf1523_7_37;
	r11 = r4->buffer;
	if( r11 == NULL ) hl_null_access();
	r12 = r11->vbuf;
	if( r12 ) goto label$daf1523_7_40;
	label$daf1523_7_37:
	r14 = (h3d__$Engine)g$_h3d_Engine;
	r13 = r14->CURRENT;
	h2d_TileLayerContent_alloc(r4,r13);
	label$daf1523_7_40:
	r15 = r4->state;
	...
	r9 = r3 - r6;
	r17 = &r9;
	h2d_impl_BatchDrawState_drawQuads(r15,r1,r11,r16,r17);
	return;
}
