...
vvirtual* hxd_fmt_fbx_FbxTools_get(vvirtual* r0,String r1,bool* r2) {
	...
	r10 = r4->length;
	if( r8 >= r10 ) goto label$08b5931_1_61;
	r10 = r4->length;
	...
	label$08b5931_1_45:
	if( r14 ) goto label$08b5931_1_60;
...
hl__types__ArrayBytes_Int hxd_fmt_fbx_FbxTools_getInts(vvirtual* r0) {
	...
	r1 = r2->length;
	r3 = 1;
	if( r1 == r3 ) goto label$08b5931_3_15;
	...
	r1 = 0;
	r3 = r2->length;
	if( ((unsigned)r1) < ((unsigned)r3) ) goto label$08b5931_3_22;
	r7 = NULL;
	goto label$08b5931_3_25;
	label$08b5931_3_22:
	r8 = r2->array;
	r6 = ((vdynamic**)(r8 + 1))[r1];
	r7 = (venum*)r6;
	...
	r3 = 4;
	if( r1 != r3 ) goto label$08b5931_3_31;
...
hl__types__ArrayBytes_Float hxd_fmt_fbx_FbxTools_getFloats(vvirtual* r0) {
	...
	r2 = r3->length;
	r4 = 1;
	if( r2 == r4 ) goto label$08b5931_4_15;
	...
	r2 = 0;
	r4 = r3->length;
	if( ((unsigned)r2) < ((unsigned)r4) ) goto label$08b5931_4_22;
	r8 = NULL;
	goto label$08b5931_4_25;
	label$08b5931_4_22:
	r9 = r3->array;
	r7 = ((vdynamic**)(r9 + 1))[r2];
	r8 = (venum*)r7;
	...
	switch(r2) {
		...
		case 4:
			...
			if( r11 == NULL ) hl_null_access();
			r13 = r11->length;
			if( r2 >= r13 ) goto label$08b5931_4_58;
			r13 = r11->length;
			if( ((unsigned)r2) < ((unsigned)r13) ) goto label$08b5931_4_49;
			r4 = 0;
			goto label$08b5931_4_53;
			label$08b5931_4_49:
			r14 = r11->bytes;
			r13 = 2;
			r13 = r2 << r13;
			...
			r4 = r3->length;
			if( ((unsigned)r2) < ((unsigned)r4) ) goto label$08b5931_4_66;
...
int hxd_fmt_fbx_FbxTools_toInt(venum* r0) {
	...
	double r4;
	int r2;
	if( r0 ) goto label$08b5931_6_3;
	r1 = (String)s$null_prop;
	...
	switch(r2) {
		...
		case 1:
			...
			r2 = hxd_fmt_fbx_FbxTools_idToInt(r4);
			return r2;
	}
}
...
String hxd_fmt_fbx_FbxTools_toString(venum* r0) {
	...
	r2 = HL__ENUM_INDEX__(r0);
	r3 = 2;
	if( r2 != r3 ) goto label$08b5931_8_9;
...
int hxd_fmt_fbx_FbxTools_getId(vvirtual* r0) {
	...
	r1 = r2->length;
	r3 = 3;
	if( r1 == r3 ) goto label$08b5931_9_10;
	r4 = hl_vfields(r0)[1] ? (*(String*)(hl_vfields(r0)[1])) : (String)hl_dyn_getp(r0->value,150958933/*name*/,&t$String);
	r5 = (String)s$_is_not_an_object;
	r4 = String___add__(r4,r5);
	hl_throw((vdynamic*)r4);
	label$08b5931_9_10:
	r2 = hl_vfields(r0)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r0)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r0->value,-393222421/*props*/,&t$hl_types_ArrayObj);
	...
	r1 = 0;
	r3 = r2->length;
	if( ((unsigned)r1) < ((unsigned)r3) ) goto label$08b5931_9_17;
	r7 = NULL;
	goto label$08b5931_9_20;
	label$08b5931_9_17:
	r8 = r2->array;
	r6 = ((vdynamic**)(r8 + 1))[r1];
	r7 = (venum*)r6;
	...
	switch(r1) {
		default:
			r4 = hl_vfields(r0)[1] ? (*(String*)(hl_vfields(r0)[1])) : (String)hl_dyn_getp(r0->value,150958933/*name*/,&t$String);
			r5 = (String)s$_is_not_an_object_;
			r4 = String___add__(r4,r5);
			r2 = hl_vfields(r0)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r0)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r0->value,-393222421/*props*/,&t$hl_types_ArrayObj);
			r5 = Std_string(((vdynamic*)r2));
			r4 = String___add__(r4,r5);
...
String hxd_fmt_fbx_FbxTools_getName(vvirtual* r0) {
	...
	r1 = r2->length;
	r3 = 3;
	if( r1 == r3 ) goto label$08b5931_10_10;
	r4 = hl_vfields(r0)[1] ? (*(String*)(hl_vfields(r0)[1])) : (String)hl_dyn_getp(r0->value,150958933/*name*/,&t$String);
	r5 = (String)s$_is_not_an_object;
	r4 = String___add__(r4,r5);
	hl_throw((vdynamic*)r4);
	...
	r1 = 1;
	r3 = r2->length;
	if( ((unsigned)r1) < ((unsigned)r3) ) goto label$08b5931_10_17;
	r7 = NULL;
	goto label$08b5931_10_20;
	label$08b5931_10_17:
	r8 = r2->array;
	r6 = ((vdynamic**)(r8 + 1))[r1];
	r7 = (venum*)r6;
	...
	r1 = HL__ENUM_INDEX__(r7);
	r3 = 2;
	if( r1 != r3 ) goto label$08b5931_10_32;
	r4 = ((hxd_fmt_fbx_FbxProp_PString*)r7)->p0;
	if( r4 == NULL ) hl_null_access();
	r9 = (String)s$4501c09;
	r2 = String_split(r4,r9);
	if( r2 == NULL ) hl_null_access();
...
String hxd_fmt_fbx_FbxTools_getType(vvirtual* r0) {
	...
	r1 = r2->length;
	r3 = 3;
	if( r1 == r3 ) goto label$08b5931_11_10;
	r4 = hl_vfields(r0)[1] ? (*(String*)(hl_vfields(r0)[1])) : (String)hl_dyn_getp(r0->value,150958933/*name*/,&t$String);
	r5 = (String)s$_is_not_an_object;
	r4 = String___add__(r4,r5);
	hl_throw((vdynamic*)r4);
	...
	r1 = 2;
	r3 = r2->length;
	if( ((unsigned)r1) < ((unsigned)r3) ) goto label$08b5931_11_17;
	r7 = NULL;
	goto label$08b5931_11_20;
	label$08b5931_11_17:
	r8 = r2->array;
	r6 = ((vdynamic**)(r8 + 1))[r1];
	r7 = (venum*)r6;
	...
	r1 = HL__ENUM_INDEX__(r7);
	r3 = 2;
	if( r1 != r3 ) goto label$08b5931_11_26;
	r4 = ((hxd_fmt_fbx_FbxProp_PString*)r7)->p0;
	return r4;
	label$08b5931_11_26:
	r4 = hl_vfields(r0)[1] ? (*(String*)(hl_vfields(r0)[1])) : (String)hl_dyn_getp(r0->value,150958933/*name*/,&t$String);
