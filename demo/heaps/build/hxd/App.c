...
void hxd_App_onContextLost(hxd__App r0) {
	h3d__scene__Scene r2;
	r2 = r0->s3d;
	if( !r2 ) goto label$fffc6b7_4_5;
	r2 = r0->s3d;
	if( r2 == NULL ) hl_null_access();
	h3d_scene_Scene_onContextLost(r2);
	label$fffc6b7_4_5:
	return;
}
...
void hxd_App_setup__$1(venum* r0) {
	...
	r6 = 0;
	r7 = r5->length;
	if( ((unsigned)r6) < ((unsigned)r7) ) goto label$fffc6b7_6_17;
	r8 = false;
	goto label$fffc6b7_6_20;
	label$fffc6b7_6_17:
	r9 = r5->array;
	r4 = ((vdynamic**)(r9 + 1))[r6];
	r8 = (bool)hl_dyn_casti(&r4,&t$_dyn,&t$_bool);
	label$fffc6b7_6_20:
	if( !r8 ) goto label$fffc6b7_6_24;
	r3 = ((Enumt$ctx_9f59bf0*)r0)->p1;
	if( r3 == NULL ) hl_null_access();
	hxd_App_onResize(r3);
	label$fffc6b7_6_24:
...
void hxd_App_setup__$2(venum* r0) {
	...
	r3 = true;
	r4 = r1->length;
	if( ((unsigned)r2) < ((unsigned)r4) ) goto label$fffc6b7_7_7;
...
void hxd_App_setup(hxd__App r0) {
	...
	r8 = r0->engine;
	if( r8 == NULL ) hl_null_access();
	r9 = hl_alloc_closure_ptr(&t$fun_5794eed,hxd_App_onContextLost,r0);
	r8->onContextLost = r9;
	r8 = r0->engine;
	if( r8 == NULL ) hl_null_access();
	...
	r14 = r0->s2d;
	if( r14 ) goto label$fffc6b7_8_41;
	r17 = NULL;
	goto label$fffc6b7_8_45;
	label$fffc6b7_8_41:
	r17 = r14->f$42;
	if( r17 ) goto label$fffc6b7_8_45;
	...
	if( r15 == NULL ) hl_null_access();
	r11 = r0->s3d;
	if( r11 ) goto label$fffc6b7_8_53;
	r17 = NULL;
	goto label$fffc6b7_8_57;
	label$fffc6b7_8_53:
	r17 = r11->f$27;
	if( r17 ) goto label$fffc6b7_8_57;
...
void hxd_App_mainLoop(hxd__App r0) {
	...
	r3 = r0->isDisposed;
	if( !r3 ) goto label$fffc6b7_11_7;
	return;
	label$fffc6b7_11_7:
	r5 = (hxd__$Timer)g$_hxd_Timer;
	r4 = r5->dt;
	hxd_App_update(r0,r4);
	r3 = r0->isDisposed;
	if( !r3 ) goto label$fffc6b7_11_13;
	return;
	label$fffc6b7_11_13:
	r5 = (hxd__$Timer)g$_hxd_Timer;
	r4 = r5->dt;
	r6 = r0->s2d;
	if( !r6 ) goto label$fffc6b7_11_20;
	r6 = r0->s2d;
	if( r6 == NULL ) hl_null_access();
	h2d_Scene_setElapsedTime(r6,r4);
	label$fffc6b7_11_20:
	r7 = r0->s3d;
	if( !r7 ) goto label$fffc6b7_11_25;
	r7 = r0->s3d;
