...
bool hxd_System_mainLoop() {
	...
	((void (*)(h3d__impl__Driver))r9->$type->vobj_proto[23])(r9);
	label$7609c18_2_25:
	r1 = true;
	return r1;
}
...
void hxd_System_reportError(vdynamic* r0) {
	...
	r9 = r10;
	label$7609c18_9_21:
	hl_trap(trap$0,r11,label$7609c18_9_31);
	r12 = Sys_stderr();
	if( r12 == NULL ) hl_null_access();
	r10 = String___add__(r10,r6);
	r13 = (String)s$81051bc;
	r10 = String___add__(r10,r13);
	r14 = NULL;
	haxe_io_Output_writeString(r12,r10,r14);
	hl_endtrap(trap$0);
	goto label$7609c18_9_32;
	label$7609c18_9_31:
	r15 = NULL;
	label$7609c18_9_32:
	r10 = Sys_systemName();
	r13 = (String)s$Windows;
	if( r10 == r13 || (r10 && r13 && String___compare(r10,(vdynamic*)r13) == 0) ) goto label$7609c18_9_36;
	return;
	label$7609c18_9_36:
	r16 = (hxd__$System)g$_hxd_System;
	r4 = r16->dismissErrors;
	if( !r4 ) goto label$7609c18_9_40;
	return;
	label$7609c18_9_40:
	r17 = (hl__WinLog)hl_alloc_obj(&t$hl_WinLog);
	r10 = (String)s$Uncaught_Exception;
	r18 = 500;
	r19 = 400;
	hl_WinLog_new(r17,r10,r18,r19);
	r13 = (String)s$68b329d;
	r10 = String___add__(r9,r13);
	r10 = String___add__(r10,r6);
	r8 = NULL;
	hl_WinLog_setTextContent(r17,r10,r8);
	r20 = (hl__Button)hl_alloc_obj(&t$hl_Button);
	r10 = (String)s$Continue;
	hl_Button_new(r20,((hl__Window)r17),r10);
	r22 = &cl$0;
	r20->onClick = r22;
	r21 = (hl__Button)hl_alloc_obj(&t$hl_Button);
	r10 = (String)s$Dismiss_all;
	hl_Button_new(r21,((hl__Window)r17),r10);
	r22 = &cl$1;
	r21->onClick = r22;
	r23 = (hl__Button)hl_alloc_obj(&t$hl_Button);
	r10 = (String)s$Exit;
	hl_Button_new(r23,((hl__Window)r17),r10);
	r22 = &cl$2;
	r23->onClick = r22;
	label$7609c18_9_65:
	r4 = true;
	r18 = ui_ui_loop(r4);
	r19 = 2;
	if( r18 == r19 ) goto label$7609c18_9_72;
	hxd_System_timeoutTick();
	goto label$7609c18_9_65;
	label$7609c18_9_72:
	if( r17 == NULL ) hl_null_access();
	hl_Window_destroy(((hl__Window)r17));
	return;
}
...
void hxd_System_setNativeCursor(venum* r0) {
	...
	switch(r7) {
		...
		case 5:
			...
			if( r6 == NULL ) hl_null_access();
			r11 = r6->alloc;
			if( r11 ) goto label$7609c18_10_98;
			...
			r13 = r11->length;
			if( r7 >= r13 ) goto label$7609c18_10_98;
			r13 = r11->length;
			if( ((unsigned)r7) < ((unsigned)r13) ) goto label$7609c18_10_57;
			r15 = NULL;
			goto label$7609c18_10_60;
			label$7609c18_10_57:
			r16 = r11->array;
			...
			r12 = r6->offsetX;
			r13 = 0;
			if( r12 < r13 ) goto label$7609c18_10_79;
			r12 = r6->offsetX;
			r13 = r17->width;
			if( r12 >= r13 ) goto label$7609c18_10_79;
			r12 = r6->offsetY;
			...
			r12 = r6->offsetY;
			r13 = r17->height;
			if( r12 < r13 ) goto label$7609c18_10_81;
			label$7609c18_10_79:
			...
			r7 = r11->length;
			r12 = 1;
			if( r12 >= r7 ) goto label$7609c18_10_107;
			r4 = (hxd__$System)g$_hxd_System;
			r4->currentCustomCursor = r6;
			hxd_CustomCursor_reset(r6);
			label$7609c18_10_107:
			r11 = r6->alloc;
			if( r11 == NULL ) hl_null_access();
			r7 = r6->frameIndex;
			r12 = r11->length;
			if( ((unsigned)r7) < ((unsigned)r12) ) goto label$7609c18_10_114;
			r9 = NULL;
			goto label$7609c18_10_117;
			label$7609c18_10_114:
			r16 = r11->array;
			r5 = ((vdynamic**)(r16 + 1))[r7];
			r9 = (sdl_cursor*)hl_dyn_castp(&r5,&t$_dyn,&t$sdl_cursor);
			label$7609c18_10_117:
			r8 = r9;
			goto label$7609c18_10_121;
		case 6:
			r10 = (String)s$assert;
	...
	label$7609c18_10_121:
	sdl__Cursor_Cursor_Impl__set(r8);
	r4 = (hxd__$System)g$_hxd_System;
	r2 = r4->cursorVisible;
	if( r2 ) goto label$7609c18_10_130;
	r2 = true;
	r4 = (hxd__$System)g$_hxd_System;
	r4->cursorVisible = r2;
	r2 = true;
	sdl_show_cursor(r2);
	label$7609c18_10_130:
	return;
}
