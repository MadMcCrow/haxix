...
void hxd_Key_onEvent(hxd__Event r0) {
	...
	switch(r2) {
		...
		case 6:
		case 7:
			goto label$ae0efc9_3_124;
		case 0:
			r2 = r0->button;
			r4 = 5;
			if( r2 >= r4 ) goto label$ae0efc9_3_24;
			...
			r4 = r4 + r8;
			r8 = r5->length;
			if( ((unsigned)r2) < ((unsigned)r8) ) goto label$ae0efc9_3_20;
		...
		case 1:
			r2 = r0->button;
			r4 = 5;
			if( r2 >= r4 ) goto label$ae0efc9_3_44;
			r6 = (hxd__$Key)g$_hxd_Key;
			r5 = r6->keyPressed;
			if( r5 == NULL ) hl_null_access();
			r2 = r0->button;
			...
			r4 = -r4;
			r8 = r5->length;
			if( ((unsigned)r2) < ((unsigned)r8) ) goto label$ae0efc9_3_40;
			hl_types_ArrayBytes_Int___expand(r5,r2);
			label$ae0efc9_3_40:
			r9 = r5->bytes;
			r8 = 2;
		...
		case 5:
			...
			r10 = r0->wheelDelta;
			r11 = 0.;
			if( !(r11 < r10) ) goto label$ae0efc9_3_53;
			r2 = 6;
			goto label$ae0efc9_3_54;
			label$ae0efc9_3_53:
			r2 = 5;
			label$ae0efc9_3_54:
			r7 = (hxd__$Timer)g$_hxd_Timer;
			...
			r4 = r4 + r8;
			r8 = r5->length;
			if( ((unsigned)r2) < ((unsigned)r8) ) goto label$ae0efc9_3_61;
			hl_types_ArrayBytes_Int___expand(r5,r2);
			label$ae0efc9_3_61:
			r9 = r5->bytes;
			r8 = 2;
		...
		case 8:
			...
			if( r12 ) goto label$ae0efc9_3_84;
			r6 = (hxd__$Key)g$_hxd_Key;
			r5 = r6->keyPressed;
			if( r5 == NULL ) hl_null_access();
			r2 = r0->keyCode;
			r4 = r5->length;
			if( ((unsigned)r2) < ((unsigned)r4) ) goto label$ae0efc9_3_77;
			r2 = 0;
			goto label$ae0efc9_3_81;
			label$ae0efc9_3_77:
			r9 = r5->bytes;
			r4 = 2;
			r4 = r2 << r4;
			...
			label$ae0efc9_3_81:
			r4 = 0;
			if( r4 >= r2 ) goto label$ae0efc9_3_84;
			return;
			label$ae0efc9_3_84:
			r6 = (hxd__$Key)g$_hxd_Key;
			r5 = r6->keyPressed;
			...
			r4 = r4 + r8;
			r8 = r5->length;
			if( ((unsigned)r2) < ((unsigned)r8) ) goto label$ae0efc9_3_95;
			hl_types_ArrayBytes_Int___expand(r5,r2);
			label$ae0efc9_3_95:
			r9 = r5->bytes;
			r8 = 2;
		...
		case 9:
			...
			r4 = -r4;
			r8 = r5->length;
			if( ((unsigned)r2) < ((unsigned)r8) ) goto label$ae0efc9_3_112;
			hl_types_ArrayBytes_Int___expand(r5,r2);
			label$ae0efc9_3_112:
			r9 = r5->bytes;
			r8 = 2;
		...
		case 10:
			...
			r2 = 0;
			r2 = 0;
			r5 = hl_types_ArrayBase_allocI32(r9,r2);
			r6 = (hxd__$Key)g$_hxd_Key;
			r6->keyPressed = r5;
	}
	label$ae0efc9_3_124:
