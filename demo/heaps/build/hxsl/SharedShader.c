...
void hxsl_SharedShader_new(hxsl__SharedShader r0,String r1) {
	...
	return;
	label$f922435_1_13:
	r12 = (hxsl__Serializer)hl_alloc_obj(&t$hxsl_Serializer);
	hxsl_Serializer_new(r12);
	r11 = hxsl_Serializer_unserialize(r12,r1);
	r0->data = r11;
	r8 = 0;
	r11 = r0->data;
	if( r11 == NULL ) hl_null_access();
	r5 = hl_vfields(r11)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r11)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r11->value,239676598/*vars*/,&t$hl_types_ArrayObj);
	label$f922435_1_21:
	if( r5 == NULL ) hl_null_access();
	r13 = r5->length;
	if( r8 >= r13 ) goto label$f922435_1_35;
	r13 = r5->length;
	if( ((unsigned)r8) < ((unsigned)r13) ) goto label$f922435_1_29;
	r14 = NULL;
	goto label$f922435_1_32;
	label$f922435_1_29:
	r6 = r5->array;
	r10 = ((vdynamic**)(r6 + 1))[r8];
	r14 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r10);
	label$f922435_1_32:
	++r8;
	hxsl_SharedShader_initVarId(r0,r14);
	goto label$f922435_1_21;
	label$f922435_1_35:
	r11 = r0->data;
	r10 = hxsl_SharedShader_compactMem(((vdynamic*)r11));
	r11 = hl_to_virtual(&t$vrt_f479cb2,(vdynamic*)r10);
	r0->data = r11;
...
hxsl__ShaderInstance hxsl_SharedShader_makeInstance(hxsl__SharedShader r0,int r1) {
	...
	vvirtual *r6, *r9, *r17, *r18;
	hxsl__Eval r2;
	venum *r8, *r12;
	bool r15;
	haxe__ds__IntMap r22;
	hxsl__ShaderInstance r19;
	...
	r4 = r0->consts;
	label$f922435_3_3:
	if( !r4 ) goto label$f922435_3_50;
	if( r4 == NULL ) hl_null_access();
	r6 = r4->v;
	r9 = r4->v;
	if( r9 == NULL ) hl_null_access();
	r8 = hl_vfields(r9)[5] ? (*(venum**)(hl_vfields(r9)[5])) : (venum*)hl_dyn_getp(r9->value,218690500/*type*/,&t$hxsl_Type);
	...
	switch(r7) {
		...
		case 2:
			...
			r7 = r7 & r13;
			r13 = 0;
			if( r7 != r13 ) goto label$f922435_3_33;
			r15 = false;
			goto label$f922435_3_34;
			label$f922435_3_33:
			r15 = true;
			label$f922435_3_34:
	...
	r15 = true;
	r2->inlineCalls = r15;
	r16 = (hxsl__$SharedShader)g$_hxsl_SharedShader;
	r15 = r16->UNROLL_LOOPS;
	r2->unrollLoops = r15;
	r17 = r0->data;
	r17 = hxsl_Eval_eval(r2,r17);
	r11 = hxsl_SharedShader_compactMem(((vdynamic*)r17));
	r18 = hl_to_virtual(&t$vrt_f479cb2,(vdynamic*)r11);
	r19 = (hxsl__ShaderInstance)hl_alloc_obj(&t$hxsl_ShaderInstance);
	hxsl_ShaderInstance_new(r19,r18);
	r7 = 0;
	r0->paramsCount = r7;
	r7 = 0;
	r18 = r0->data;
	if( r18 == NULL ) hl_null_access();
	r20 = hl_vfields(r18)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r18)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r18->value,239676598/*vars*/,&t$hl_types_ArrayObj);
	label$f922435_3_68:
	if( r20 == NULL ) hl_null_access();
	r14 = r20->length;
	if( r7 >= r14 ) goto label$f922435_3_82;
	r14 = r20->length;
	if( ((unsigned)r7) < ((unsigned)r14) ) goto label$f922435_3_76;
	r6 = NULL;
	goto label$f922435_3_79;
	label$f922435_3_76:
	r21 = r20->array;
	r11 = ((vdynamic**)(r21 + 1))[r7];
	r6 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r11);
	label$f922435_3_79:
	++r7;
	hxsl_SharedShader_addParam(r0,r2,r19,r6);
	goto label$f922435_3_68;
	label$f922435_3_82:
	r22 = r0->instanceCache;
	if( r22 == NULL ) hl_null_access();
	haxe_ds_IntMap_set(r22,r1,((vdynamic*)r19));
	return r19;
}
...
void hxsl_SharedShader_initVarId(hxsl__SharedShader r0,vvirtual* r1) {
	...
	if( hl_vfields(r1)[0] ) *(int*)(hl_vfields(r1)[0]) = (int)r3; else hl_dyn_seti(r1->value,23515/*id*/,&t$_i32,r3);
	r4 = hl_vfields(r1)[5] ? (*(venum**)(hl_vfields(r1)[5])) : (venum*)hl_dyn_getp(r1->value,218690500/*type*/,&t$hxsl_Type);
	if( r4 == NULL ) hl_null_access();
	r3 = HL__ENUM_INDEX__(r4);
	r6 = 13;
	if( r3 != r6 ) goto label$f922435_5_24;
	r7 = ((hxsl_Type_TStruct*)r4)->p0;
	r3 = 0;
	label$f922435_5_10:
	if( r7 == NULL ) hl_null_access();
	r8 = r7->length;
	if( r3 >= r8 ) goto label$f922435_5_24;
	r8 = r7->length;
	if( ((unsigned)r3) < ((unsigned)r8) ) goto label$f922435_5_18;
	r2 = NULL;
	goto label$f922435_5_21;
	label$f922435_5_18:
	r10 = r7->array;
	r9 = ((vdynamic**)(r10 + 1))[r3];
	r2 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r9);
	label$f922435_5_21:
	++r3;
	hxsl_SharedShader_initVarId(r0,r2);
	goto label$f922435_5_10;
	label$f922435_5_24:
	return;
}
...
void hxsl_SharedShader_browseVar(hxsl__SharedShader r0,vvirtual* r1,String r2) {
	...
	varray *r14;
	int r9, r10, r12, r19;
	if( r2 ) goto label$f922435_6_4;
	r4 = hxsl_Tools_getName(r1);
	r2 = r4;
	goto label$f922435_6_10;
	label$f922435_6_4:
	r6 = (String)s$5058f1a;
	if( r1 == NULL ) hl_null_access();
	r7 = hl_vfields(r1)[2] ? (*(String*)(hl_vfields(r1)[2])) : (String)hl_dyn_getp(r1->value,150958933/*name*/,&t$String);
	r6 = String___add__(r6,r7);
	r4 = String___add__(r2,r6);
	r2 = r4;
	label$f922435_6_10:
	if( r1 == NULL ) hl_null_access();
	...
	r10 = 13;
	if( r9 != r10 ) goto label$f922435_6_33;
	r11 = ((hxsl_Type_TStruct*)r8)->p0;
	r9 = 0;
	label$f922435_6_18:
	if( r11 == NULL ) hl_null_access();
	r12 = r11->length;
	if( r9 >= r12 ) goto label$f922435_6_32;
	r12 = r11->length;
	if( ((unsigned)r9) < ((unsigned)r12) ) goto label$f922435_6_26;
	r5 = NULL;
	goto label$f922435_6_29;
	label$f922435_6_26:
	r14 = r11->array;
	r13 = ((vdynamic**)(r14 + 1))[r9];
	r5 = hl_to_virtual(&t$vrt_09f4a29,(vdynamic*)r13);
	label$f922435_6_29:
	++r9;
	hxsl_SharedShader_browseVar(r0,r5,r2);
	goto label$f922435_6_18;
	label$f922435_6_32:
	goto label$f922435_6_67;
	label$f922435_6_33:
	r9 = 0;
	...
	if( r15 != r16 ) goto label$f922435_6_44;
	r10 = hxsl_Globals_allocID(r4);
	r9 = r10;
	r11 = r0->globals;
	if( r11 == NULL ) hl_null_access();
	...
	if( r18 ) goto label$f922435_6_47;
	return;
	label$f922435_6_47:
	r10 = hxsl_Tools_getConstBits(r1);
	r19 = 0;
	if( r19 >= r10 ) goto label$f922435_6_67;
	r20 = r0->consts;
	if( r20 ) goto label$f922435_6_54;
	r12 = 0;
	goto label$f922435_6_61;
	label$f922435_6_54:
	r20 = r0->consts;
	if( r20 == NULL ) hl_null_access();
	r12 = r20->pos;
...
vdynamic* hxsl_SharedShader_compactMem(vdynamic* r0) {
	return r0;
}
