...
void hxsl_Shader_updateConstantsFinal(hxsl__Shader r0,hxsl__Globals r1) {
	...
	r2 = r3->consts;
	label$09c1dc0_6_3:
	if( !r2 ) goto label$09c1dc0_6_146;
	...
	switch(r6) {
		...
		case 1:
			...
			r7 = ((unsigned)r6) >> r13;
			r13 = 0;
			if( r7 == r13 ) goto label$09c1dc0_6_56;
			r12 = (String)s$Constant_;
			r11 = r2->v;
			if( r11 == NULL ) hl_null_access();
			r14 = hl_vfields(r11)[2] ? (*(String*)(hl_vfields(r11)[2])) : (String)hl_dyn_getp(r11->value,150958933/*name*/,&t$String);
			r12 = String___add__(r12,r14);
			r14 = (String)s$_is_outside_range_;
			r12 = String___add__(r12,r14);
			r7 = r6;
			r15 = &r7;
			r16 = hl_itos(r7,r15);
			...
			r7 = r7 | r13;
			r0->constBits = r7;
			goto label$09c1dc0_6_143;
		case 2:
			r18 = (bool)hl_dyn_casti(&r8,&t$_dyn,&t$_bool);
			if( !r18 ) goto label$09c1dc0_6_70;
			r6 = r0->constBits;
			r7 = 1;
			r13 = r2->pos;
			r7 = r7 << r13;
		...
		case 17:
			...
			if( r8 ) goto label$09c1dc0_6_76;
			r5 = r2->next;
			r2 = r5;
			goto label$09c1dc0_6_3;
			label$09c1dc0_6_76:
			r19 = hl_to_virtual(&t$vrt_7cde10b,(vdynamic*)r8);
			if( r19 == NULL ) hl_null_access();
			r20 = hl_vfields(r19)[0] ? (*(venum**)(hl_vfields(r19)[0])) : (venum*)hl_dyn_getp(r19->value,-321781698/*channel*/,&t$hxsl_Channel);
			r21 = hl_vfields(r19)[1] ? (*(h3d__mat__Texture*)(hl_vfields(r19)[1])) : (h3d__mat__Texture)hl_dyn_getp(r19->value,-18823348/*texture*/,&t$h3d_mat_Texture);
			if( r21 ) goto label$09c1dc0_6_84;
			r22 = (venum*)g$hxsl_Channel_Unknown;
			r20 = r22;
			goto label$09c1dc0_6_131;
			label$09c1dc0_6_84:
			if( !r20 ) goto label$09c1dc0_6_87;
			r23 = (venum*)g$hxsl_Channel_Unknown;
			if( r20 != r23 ) goto label$09c1dc0_6_131;
			label$09c1dc0_6_87:
			switch(r6) {
				default:
				case 0:
				...
				case 1:
					...
					r24 = r21->format;
					r26 = (h3d__mat__$Texture)g$_h3d_mat_Texture;
					r25 = r26->nativeFormat;
					if( r24 != r25 ) goto label$09c1dc0_6_105;
					r22 = (venum*)g$hxsl_Channel_PackedFloat;
					r20 = r22;
					goto label$09c1dc0_6_113;
					label$09c1dc0_6_105:
					r12 = (String)s$Constant_;
					r11 = r2->v;
					if( r11 == NULL ) hl_null_access();
				...
				case 3:
					...
					r26 = (h3d__mat__$Texture)g$_h3d_mat_Texture;
					r25 = r26->nativeFormat;
					if( r24 != r25 ) goto label$09c1dc0_6_123;
					r22 = (venum*)g$hxsl_Channel_PackedNormal;
					r20 = r22;
					goto label$09c1dc0_6_131;
					label$09c1dc0_6_123:
					r12 = (String)s$Constant_;
			...
			r7 = r0->constBits;
			r21 = hl_vfields(r19)[1] ? (*(h3d__mat__Texture*)(hl_vfields(r19)[1])) : (h3d__mat__Texture)hl_dyn_getp(r19->value,-18823348/*texture*/,&t$h3d_mat_Texture);
			r13 = hxsl_Globals_allocChannelID(r1,r21);
			r17 = 3;
			r13 = r13 << r17;
			if( r20 == NULL ) hl_null_access();
			r17 = HL__ENUM_INDEX__(r20);
			r13 = r13 | r17;
			r17 = r2->pos;
			r13 = r13 << r17;
			r7 = r7 | r13;
	...
	if( r27 ) goto label$09c1dc0_6_156;
	r28 = hxsl_SharedShader_makeInstance(r3,r6);
	goto label$09c1dc0_6_157;
	label$09c1dc0_6_156:
	r28 = r27;
	label$09c1dc0_6_157:
	r0->instance = r28;
