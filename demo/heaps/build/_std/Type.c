...
vdynamic* Type_createEnum(hl__BaseType r0,String r1,hl__types__ArrayDyn r2) {
	...
	if( r8 ) goto label$9fea9d9_13_15;
...
vdynamic* Type_createEnumIndex(hl__BaseType r0,int r1,hl__types__ArrayDyn r2) {
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( r1 < r5 ) goto label$9fea9d9_14_20;
	label$9fea9d9_14_8:
	...
	hl_throw((vdynamic*)r7);
	label$9fea9d9_14_20:
	if( !r2 ) goto label$9fea9d9_14_25;
	if( r2 == NULL ) hl_null_access();
	r4 = hl_types_ArrayDyn_get_length(r2);
	r5 = 0;
	if( r4 != r5 ) goto label$9fea9d9_14_52;
	label$9fea9d9_14_25:
	r13 = r3->__evalues__;
	r5 = r13->size;
	if( r1 < r5 ) goto label$9fea9d9_14_30;
	r15 = NULL;
	goto label$9fea9d9_14_32;
	label$9fea9d9_14_30:
	r14 = r3->__evalues__;
	r15 = ((vdynamic**)(r14 + 1))[r1];
	label$9fea9d9_14_32:
	if( r15 ) goto label$9fea9d9_14_51;
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( ((unsigned)r1) < ((unsigned)r5) ) goto label$9fea9d9_14_44;
	r8 = NULL;
	goto label$9fea9d9_14_47;
	label$9fea9d9_14_44:
	r14 = r6->array;
	r15 = ((vdynamic**)(r14 + 1))[r1];
	r8 = (String)r15;
	...
	if( r16 ) goto label$9fea9d9_14_78;
	r17 = r2->array;
	if( r17 == NULL ) hl_null_access();
	r4 = r17->length;
	r18 = &t$_dyn;
	...
	r19 = r17->length;
	label$9fea9d9_14_67:
	if( r5 >= r19 ) goto label$9fea9d9_14_77;
	r20 = r5;
	++r5;
	if( r12 == NULL ) hl_null_access();
	r17 = r12->array;
	...
	goto label$9fea9d9_14_67;
	label$9fea9d9_14_77:
	goto label$9fea9d9_14_83;
	label$9fea9d9_14_78:
	r17 = r2->array;
	...
	if( r11 ) goto label$9fea9d9_14_116;
	r7 = (String)s$Constructor_;
	r8 = r3->__ename__;
	r7 = String___add__(r7,r8);
	r8 = (String)s$5058f1a;
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( ((unsigned)r1) < ((unsigned)r5) ) goto label$9fea9d9_14_102;
	r8 = NULL;
	goto label$9fea9d9_14_105;
	label$9fea9d9_14_102:
	r14 = r6->array;
	r15 = ((vdynamic**)(r14 + 1))[r1];
	r8 = (String)r15;
	label$9fea9d9_14_105:
	r7 = String___add__(r7,r8);
...
hl__types__ArrayDyn Type_allEnums(hl__BaseType r0) {
	...
	r9 = r3->size;
	label$9fea9d9_19_12:
	if( r5 >= r9 ) goto label$9fea9d9_19_23;
	r11 = r5;
	++r5;
	if( r1 == NULL ) hl_null_access();
	r10 = r1->__evalues__;
	r13 = ((vdynamic**)(r10 + 1))[r11];
	if( !r13 ) goto label$9fea9d9_19_22;
	if( r2 == NULL ) hl_null_access();
	r12 = hl_types_ArrayDyn_push(r2,r13);
	label$9fea9d9_19_22:
	goto label$9fea9d9_19_12;
	label$9fea9d9_19_23:
	return r2;
}
