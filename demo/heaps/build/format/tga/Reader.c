...
hl__types__ArrayBytes_Int format_tga_Reader_readImageData(format__tga__Reader r0,vvirtual* r1,hl__types__ArrayBytes_Int r2) {
	...
	switch(r3) {
		default:
			r5 = (String)s$Unsupported_image_data_type_;
		...
		case 1:
			...
			r7 = hl_vfields(r1)[9] ? (*(int*)(hl_vfields(r1)[9])) : (int)hl_dyn_geti(r1->value,-362629759/*width*/,&t$_i32);
			r8 = hl_vfields(r1)[6] ? (*(int*)(hl_vfields(r1)[6])) : (int)hl_dyn_geti(r1->value,38537191/*height*/,&t$_i32);
			r7 = r7 * r8;
			r8 = hl_vfields(r1)[3] ? (*(int*)(hl_vfields(r1)[3])) : (int)hl_dyn_geti(r1->value,257510570/*colorMapFirstIndex*/,&t$_i32);
			r9 = false;
		...
		case 2:
			...
			r8 = hl_vfields(r1)[6] ? (*(int*)(hl_vfields(r1)[6])) : (int)hl_dyn_geti(r1->value,38537191/*height*/,&t$_i32);
			r7 = r7 * r8;
			r8 = hl_vfields(r1)[0] ? (*(int*)(hl_vfields(r1)[0])) : (int)hl_dyn_geti(r1->value,-200354399/*alphaChannelBits*/,&t$_i32);
			r9 = false;
...
hl__types__ArrayBytes_Int format_tga_Reader_readPixels(format__tga__Reader r0,int r1,int r2,int r3,bool r4) {
	...
	*(int*)(r6 + r12) = r9;
	...
	label$d29525c_6_60:
	if( !r4 ) goto label$d29525c_6_119;
	r9 = 0;
	label$d29525c_6_62:
	if( r9 >= r2 ) goto label$d29525c_6_118;
	r17 = r0->i;
	if( r17 == NULL ) hl_null_access();
	...
	r20 = r20 & r21;
	r21 = 0;
	if( r20 == r21 ) goto label$d29525c_6_95;
	r21 = 127;
	r20 = r12 & r21;
	r12 = r20;
	...
	label$d29525c_6_79:
	r22 = 0;
	if( r12 < r22 ) goto label$d29525c_6_94;
	if( r10 == NULL ) hl_null_access();
	r21 = r9;
	++r9;
	r23 = r10->length;
	if( ((unsigned)r21) < ((unsigned)r23) ) goto label$d29525c_6_88;
	...
	*(int*)(r6 + r23) = r20;
	--r12;
	goto label$d29525c_6_79;
	label$d29525c_6_94:
	goto label$d29525c_6_117;
	label$d29525c_6_95:
	r21 = 127;
	r20 = r12 & r21;
	r12 = r20;
	label$d29525c_6_98:
	r21 = 0;
	if( r12 < r21 ) goto label$d29525c_6_117;
	if( r10 == NULL ) hl_null_access();
	r20 = r9;
	++r9;
	if( r18 == NULL ) hl_null_access();
	...
	r22 = r10->length;
	if( ((unsigned)r20) < ((unsigned)r22) ) goto label$d29525c_6_111;
	...
	*(int*)(r6 + r22) = r21;
	--r12;
	goto label$d29525c_6_98;
	label$d29525c_6_117:
	goto label$d29525c_6_62;
	label$d29525c_6_118:
	goto label$d29525c_6_138;
	label$d29525c_6_119:
	r9 = 0;
	r12 = r2;
	label$d29525c_6_121:
	if( r9 >= r12 ) goto label$d29525c_6_138;
	r20 = r9;
	++r9;
	if( r10 == NULL ) hl_null_access();
	if( r18 == NULL ) hl_null_access();
	...
	r23 = r10->length;
	if( ((unsigned)r20) < ((unsigned)r23) ) goto label$d29525c_6_133;
	hl_types_ArrayBytes_Int___expand(r10,r20);
	label$d29525c_6_133:
	r6 = r10->bytes;
	r23 = 2;
...
hl__types__ArrayBytes_Int format_tga_Reader_readMono(format__tga__Reader r0,int r1,int r2,int r3,bool r4) {
	...
	*(int*)(r6 + r12) = r9;
	...
	label$d29525c_7_41:
	if( !r4 ) goto label$d29525c_7_100;
	r7 = 0;
	label$d29525c_7_43:
	if( r7 >= r2 ) goto label$d29525c_7_99;
	r17 = r0->i;
	if( r17 == NULL ) hl_null_access();
	...
	r12 = r12 & r20;
	r20 = 0;
	if( r12 == r20 ) goto label$d29525c_7_76;
	r20 = 127;
	r12 = r9 & r20;
	r9 = r12;
	if( r18 == NULL ) hl_null_access();
	...
	label$d29525c_7_60:
	r21 = 0;
	if( r9 < r21 ) goto label$d29525c_7_75;
	if( r10 == NULL ) hl_null_access();
	r20 = r7;
	++r7;
	r22 = r10->length;
	if( ((unsigned)r20) < ((unsigned)r22) ) goto label$d29525c_7_69;
	hl_types_ArrayBytes_Int___expand(r10,r20);
	label$d29525c_7_69:
	r6 = r10->bytes;
	r22 = 2;
	...
	*(int*)(r6 + r22) = r12;
	--r9;
	goto label$d29525c_7_60;
	label$d29525c_7_75:
	goto label$d29525c_7_98;
	label$d29525c_7_76:
	r20 = 127;
	r12 = r9 & r20;
	r9 = r12;
	label$d29525c_7_79:
	r20 = 0;
	if( r9 < r20 ) goto label$d29525c_7_98;
	if( r10 == NULL ) hl_null_access();
	r12 = r7;
	++r7;
	if( r18 == NULL ) hl_null_access();
	...
	r20 = r18->hasValue ? ((int (*)(vdynamic*,int,bool))r18->fun)((vdynamic*)r18->value,r20,r13) : ((int (*)(int,bool))r18->fun)(r20,r13);
	r21 = r10->length;
	if( ((unsigned)r12) < ((unsigned)r21) ) goto label$d29525c_7_92;
	...
	*(int*)(r6 + r21) = r20;
	--r9;
	goto label$d29525c_7_79;
	label$d29525c_7_98:
	goto label$d29525c_7_43;
	label$d29525c_7_99:
	goto label$d29525c_7_119;
	label$d29525c_7_100:
	r7 = 0;
	r9 = r2;
	label$d29525c_7_102:
	if( r7 >= r9 ) goto label$d29525c_7_119;
	r12 = r7;
	++r7;
	if( r10 == NULL ) hl_null_access();
	if( r18 == NULL ) hl_null_access();
	...
	r21 = r18->hasValue ? ((int (*)(vdynamic*,int,bool))r18->fun)((vdynamic*)r18->value,r21,r13) : ((int (*)(int,bool))r18->fun)(r21,r13);
	r22 = r10->length;
	if( ((unsigned)r12) < ((unsigned)r22) ) goto label$d29525c_7_114;
	hl_types_ArrayBytes_Int___expand(r10,r12);
	label$d29525c_7_114:
	r6 = r10->bytes;
	r22 = 2;
...
hl__types__ArrayBytes_Int format_tga_Reader_readIndexes(format__tga__Reader r0,int r1,int r2,hl__types__ArrayBytes_Int r3,int r4,bool r5) {
	...
	*(int*)(r7 + r13) = r10;
	...
	label$d29525c_8_42:
	if( !r5 ) goto label$d29525c_8_117;
	r8 = 0;
	label$d29525c_8_44:
	if( r8 >= r2 ) goto label$d29525c_8_116;
	r17 = r0->i;
	if( r17 == NULL ) hl_null_access();
	...
	r13 = r13 & r18;
	r18 = 0;
	if( r13 == r18 ) goto label$d29525c_8_85;
	r18 = 127;
	r13 = r10 & r18;
	r10 = r13;
	...
	r13 = r4 + r18;
	r18 = r3->length;
	if( ((unsigned)r13) < ((unsigned)r18) ) goto label$d29525c_8_65;
	r13 = 0;
	goto label$d29525c_8_69;
	label$d29525c_8_65:
	r7 = r3->bytes;
	r18 = 2;
	r18 = r13 << r18;
	...
	label$d29525c_8_69:
	r19 = 0;
	if( r10 < r19 ) goto label$d29525c_8_84;
	if( r11 == NULL ) hl_null_access();
	r18 = r8;
	++r8;
	r20 = r11->length;
	if( ((unsigned)r18) < ((unsigned)r20) ) goto label$d29525c_8_78;
	...
	*(int*)(r7 + r20) = r13;
	...
	label$d29525c_8_88:
	r18 = 0;
	if( r10 < r18 ) goto label$d29525c_8_115;
	if( r11 == NULL ) hl_null_access();
	r13 = r8;
	++r8;
	if( r3 == NULL ) hl_null_access();
	...
	r18 = r4 + r19;
	r19 = r3->length;
	if( ((unsigned)r18) < ((unsigned)r19) ) goto label$d29525c_8_102;
	r18 = 0;
	goto label$d29525c_8_106;
	label$d29525c_8_102:
	r7 = r3->bytes;
	r19 = 2;
	r19 = r18 << r19;
	...
	label$d29525c_8_106:
	r19 = r11->length;
	if( ((unsigned)r13) < ((unsigned)r19) ) goto label$d29525c_8_109;
	...
	*(int*)(r7 + r19) = r18;
	--r10;
	goto label$d29525c_8_88;
	label$d29525c_8_115:
	goto label$d29525c_8_44;
	label$d29525c_8_116:
	goto label$d29525c_8_144;
	label$d29525c_8_117:
	r8 = 0;
	r10 = r2;
	label$d29525c_8_119:
	if( r8 >= r10 ) goto label$d29525c_8_144;
	r13 = r8;
	++r8;
	if( r11 == NULL ) hl_null_access();
	if( r3 == NULL ) hl_null_access();
	...
	r19 = r4 + r20;
	r20 = r3->length;
	if( ((unsigned)r19) < ((unsigned)r20) ) goto label$d29525c_8_132;
	r19 = 0;
	goto label$d29525c_8_136;
	label$d29525c_8_132:
	r7 = r3->bytes;
	r20 = 2;
	r20 = r19 << r20;
	...
	label$d29525c_8_136:
	r20 = r11->length;
	if( ((unsigned)r13) < ((unsigned)r20) ) goto label$d29525c_8_139;
	hl_types_ArrayBytes_Int___expand(r11,r13);
	label$d29525c_8_139:
	r7 = r11->bytes;
	r20 = 2;
