...
void format_png_Writer_writeChunk(format__png__Writer r0,String r1,haxe__io__Bytes r2) {
	...
	vdynamic *r8;
	vbyte *r13;
	int r5, r7, r9, r10, r11, r14, r15, r16, r17;
	r4 = r0->o;
	if( r4 == NULL ) hl_null_access();
	...
	r10 = r7;
	label$b9b9fc1_3_352:
	if( r9 >= r10 ) goto label$b9b9fc1_3_439;
	r11 = r9;
	++r9;
	if( r12 == NULL ) hl_null_access();
	r13 = r12->bytes;
	r15 = *(unsigned char*)(r13 + r11);
	r14 = r5 ^ r15;
	r15 = 255;
	r14 = r14 & r15;
	r16 = 1;
	r15 = ((unsigned)r14) >> r16;
	r17 = 1;
	r16 = r14 & r17;
	r16 = -r16;
	r17 = -306674912;
