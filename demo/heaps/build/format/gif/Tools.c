...
haxe__io__Bytes format_gif_Tools_extractFullBGRA(vvirtual* r0,int r1) {
	...
	r9 = r10->h;
	label$66993a7_1_16:
	if( !r9 ) goto label$66993a7_1_172;
	...
	switch(r6) {
		...
		case 0:
			...
			r22 = 4;
			r21 = r21 + r22;
			if( r4 == r1 ) goto label$66993a7_1_73;
			if( !r2 ) goto label$66993a7_1_73;
			if( r2 == NULL ) hl_null_access();
			...
			switch(r22) {
				...
				case 1:
					...
					r24 = r17->length;
					label$66993a7_1_80:
					if( r22 >= r24 ) goto label$66993a7_1_122;
					r25 = r22;
					++r22;
					if( r17 == NULL ) hl_null_access();
					...
					r27 = 3;
					r26 = r26 * r27;
					if( r6 == r26 ) goto label$66993a7_1_109;
					...
					if( r8 != r27 ) goto label$66993a7_1_118;
					r27 = 0;
					r8 = r27;
					r27 = r20 + r21;
					r20 = r27;
					goto label$66993a7_1_121;
					label$66993a7_1_118:
					r28 = 4;
					r27 = r20 + r28;
					r20 = r27;
					label$66993a7_1_121:
					goto label$66993a7_1_80;
					label$66993a7_1_122:
					goto label$66993a7_1_158;
				case 2:
					r22 = 0;
					if( r17 == NULL ) hl_null_access();
					r24 = r17->length;
					label$66993a7_1_126:
					if( r22 >= r24 ) goto label$66993a7_1_157;
					++r22;
					if( r5 == NULL ) hl_null_access();
					r27 = 0;
					...
					if( r8 != r26 ) goto label$66993a7_1_153;
					r26 = 0;
					r8 = r26;
					r26 = r20 + r21;
					r20 = r26;
					goto label$66993a7_1_156;
					label$66993a7_1_153:
					r27 = 4;
					r26 = r20 + r27;
					r20 = r26;
					label$66993a7_1_156:
					goto label$66993a7_1_126;
					label$66993a7_1_157:
					goto label$66993a7_1_158;
				case 3:
					break;
			...
			label$66993a7_1_158:
			if( r4 != r1 ) goto label$66993a7_1_160;
			return r5;
			label$66993a7_1_160:
			++r4;
			r19 = NULL;
		...
		case 1:
			...
			r8 = 0;
			if( r6 != r8 ) goto label$66993a7_1_171;
...
haxe__io__Bytes format_gif_Tools_extractFullRGBA(vvirtual* r0,int r1) {
	...
	r9 = r10->h;
	label$66993a7_2_16:
	if( !r9 ) goto label$66993a7_2_172;
	if( r9 == NULL ) hl_null_access();
	r12 = r9->item;
	r13 = (venum*)r12;
	r11 = r9->next;
	...
	switch(r6) {
		...
		case 0:
			...
			r15 = hl_vfields(r0)[1] ? (*(haxe__io__Bytes*)(hl_vfields(r0)[1])) : (haxe__io__Bytes)hl_dyn_getp(r0->value,-390218401/*globalColorTable*/,&t$haxe_io_Bytes);
			label$66993a7_2_35:
			if( r15 ) goto label$66993a7_2_38;
			r18 = (String)s$5c1a108;
			hl_throw((vdynamic*)r18);
			label$66993a7_2_38:
			if( !r2 ) goto label$66993a7_2_46;
			if( r2 == NULL ) hl_null_access();
			r16 = hl_vfields(r2)[2] ? (*(bool*)(hl_vfields(r2)[2])) : (bool)hl_dyn_geti(r2->value,-318285023/*hasTransparentColor*/,&t$_bool);
			if( !r16 ) goto label$66993a7_2_46;
			r6 = hl_vfields(r2)[3] ? (*(int*)(hl_vfields(r2)[3])) : (int)hl_dyn_geti(r2->value,235902693/*transparentIndex*/,&t$_i32);
			r8 = 3;
			r6 = r6 * r8;
			goto label$66993a7_2_47;
			label$66993a7_2_46:
			r6 = -1;
			label$66993a7_2_47:
			r17 = hl_vfields(r14)[5] ? (*(haxe__io__Bytes*)(hl_vfields(r14)[5])) : (haxe__io__Bytes)hl_dyn_getp(r14->value,-324407906/*pixels*/,&t$haxe_io_Bytes);
			...
			r22 = 4;
			r21 = r21 + r22;
			if( r4 == r1 ) goto label$66993a7_2_73;
			if( !r2 ) goto label$66993a7_2_73;
			if( r2 == NULL ) hl_null_access();
			r23 = hl_vfields(r2)[1] ? (*(venum**)(hl_vfields(r2)[1])) : (venum*)hl_dyn_getp(r2->value,164371895/*disposalMethod*/,&t$format_gif_DisposalMethod);
			goto label$66993a7_2_74;
			label$66993a7_2_73:
			r23 = (venum*)g$b009af1;
			label$66993a7_2_74:
			if( r23 == NULL ) hl_null_access();
			...
			switch(r22) {
				...
				case 1:
					...
					r24 = r17->length;
					label$66993a7_2_80:
					if( r22 >= r24 ) goto label$66993a7_2_122;
					r25 = r22;
					++r22;
					if( r17 == NULL ) hl_null_access();
					r26 = haxe_io_Bytes_get(r17,r25);
					r27 = 3;
					r26 = r26 * r27;
					if( r6 == r26 ) goto label$66993a7_2_109;
					if( r5 == NULL ) hl_null_access();
					if( r15 == NULL ) hl_null_access();
					r28 = haxe_io_Bytes_get(r15,r26);
					haxe_io_Bytes_set(r5,r20,r28);
					...
					if( r14 == NULL ) hl_null_access();
					r27 = hl_vfields(r14)[7] ? (*(int*)(hl_vfields(r14)[7])) : (int)hl_dyn_geti(r14->value,-362629759/*width*/,&t$_i32);
					if( r8 != r27 ) goto label$66993a7_2_118;
					r27 = 0;
					r8 = r27;
					r27 = r20 + r21;
					r20 = r27;
					goto label$66993a7_2_121;
					label$66993a7_2_118:
					r28 = 4;
					r27 = r20 + r28;
					r20 = r27;
					label$66993a7_2_121:
					goto label$66993a7_2_80;
					label$66993a7_2_122:
					goto label$66993a7_2_158;
				case 2:
					r22 = 0;
					if( r17 == NULL ) hl_null_access();
					r24 = r17->length;
					label$66993a7_2_126:
					if( r22 >= r24 ) goto label$66993a7_2_157;
					++r22;
					if( r5 == NULL ) hl_null_access();
					r27 = 0;
					haxe_io_Bytes_set(r5,r20,r27);
					...
					if( r14 == NULL ) hl_null_access();
					r26 = hl_vfields(r14)[7] ? (*(int*)(hl_vfields(r14)[7])) : (int)hl_dyn_geti(r14->value,-362629759/*width*/,&t$_i32);
					if( r8 != r26 ) goto label$66993a7_2_153;
					r26 = 0;
					r8 = r26;
					r26 = r20 + r21;
					r20 = r26;
					goto label$66993a7_2_156;
					label$66993a7_2_153:
					r27 = 4;
					r26 = r20 + r27;
					r20 = r26;
					label$66993a7_2_156:
					goto label$66993a7_2_126;
					label$66993a7_2_157:
					goto label$66993a7_2_158;
				case 3:
					break;
			...
			label$66993a7_2_158:
			if( r4 != r1 ) goto label$66993a7_2_160;
			return r5;
			label$66993a7_2_160:
			++r4;
			r19 = NULL;
		...
		case 1:
			...
			r6 = HL__ENUM_INDEX__(r30);
			r8 = 0;
			if( r6 != r8 ) goto label$66993a7_2_171;
			r19 = ((format_gif_Extension_EGraphicControl*)r30)->p0;
			r2 = r19;
	}
	label$66993a7_2_171:
