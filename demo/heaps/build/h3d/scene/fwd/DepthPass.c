...
void h3d_scene_fwd_DepthPass_draw(h3d__scene__fwd__DepthPass r0,h3d__pass__PassList r1,vclosure* r2) {
	...
	r16 = NULL;
	r17 = NULL;
	h3d_Engine_pushTarget(r8,r3,r15,r16,r17);
	r5 = r0->ctx;
	if( r5 == NULL ) hl_null_access();
	r8 = r5->engine;
	if( r8 == NULL ) hl_null_access();
	r19 = r0->enableSky;
	if( !r19 ) goto label$b008eae_2_37;
	r7 = 0;
	r18 = hl_alloc_dynamic(&t$_i32);
	r18->v.i = r7;
	goto label$b008eae_2_39;
	label$b008eae_2_37:
	r7 = 16711680;
	r18 = hl_alloc_dynamic(&t$_i32);
	r18->v.i = r7;
	...
	r21->v.d = r20;
	r22 = NULL;
	h3d_Engine_clear(r8,r18,r21,r22);
	...
	if( r5 == NULL ) hl_null_access();
	r7 = r0->depthMapId;
	r23 = hl_alloc_virtual(&t$vrt_62756b6);
	if( hl_vfields(r23)[0] ) *(h3d__mat__Texture*)(hl_vfields(r23)[0]) = (h3d__mat__Texture)r3; else hl_dyn_setp(r23->value,-18823348/*texture*/,&t$h3d_mat_Texture,r3);
	h3d_scene_RenderContext_setGlobalID(r5,r7,((vdynamic*)r23));
	return;
}
