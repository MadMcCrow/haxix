...
void h3d_scene_Interactive_handleEvent(h3d__scene__Interactive r0,hxd__Event r1) {
	...
	switch(r4) {
		...
		case 1:
			...
			r4 = r1->button;
			r6 = 0;
			if( r4 != r6 ) goto label$a10b22e_4_52;
			label$a10b22e_4_36:
			r7 = r0->onRelease;
			if( r7 == NULL ) hl_null_access();
			r7->hasValue ? ((void (*)(vdynamic*,hxd__Event))r7->fun)((vdynamic*)r7->value,r1) : ((void (*)(hxd__Event))r7->fun)(r1);
			...
			r4 = r8->frameCount;
			r6 = r0->mouseDownButton;
			r9 = r1->button;
			if( r6 != r9 ) goto label$a10b22e_4_52;
			r6 = r0->lastClickFrame;
			if( r6 != r4 ) goto label$a10b22e_4_48;
			r3 = r0->allowMultiClick;
			if( !r3 ) goto label$a10b22e_4_52;
			label$a10b22e_4_48:
			r7 = r0->onClick;
			if( r7 == NULL ) hl_null_access();
			r7->hasValue ? ((void (*)(vdynamic*,hxd__Event))r7->fun)((vdynamic*)r7->value,r1) : ((void (*)(hxd__Event))r7->fun)(r1);
			r0->lastClickFrame = r4;
			label$a10b22e_4_52:
			r4 = -1;
			r0->mouseDownButton = r4;
			goto label$a10b22e_4_111;
		...
		case 10:
			r3 = r0->enableRightButton;
			if( r3 ) goto label$a10b22e_4_92;
			r4 = r1->button;
			r6 = 0;
			if( r4 != r6 ) goto label$a10b22e_4_101;
			label$a10b22e_4_92:
			r7 = r0->onRelease;
			if( r7 == NULL ) hl_null_access();
			r7->hasValue ? ((void (*)(vdynamic*,hxd__Event))r7->fun)((vdynamic*)r7->value,r1) : ((void (*)(hxd__Event))r7->fun)(r1);
...
void h3d_scene_Interactive_new(h3d__scene__Interactive r0,h3d__col__Collider r1,h3d__scene__Object r2) {
	venum *r16;
	bool r15;
	h3d__Vector4Impl r4;
	double r5, r7, r9, r11;
	...
	r0->onTextInput = r3;
	label$a10b22e_20_56:
	r4 = (h3d__Vector4Impl)hl_alloc_obj(&t$h3d_Vector4Impl);
	r5 = 0.;
	r6 = &r5;
	r7 = 0.;
	r8 = &r7;
	...
	r11 = 1.;
	r12 = &r11;
	h3d_Vector4Impl_new(r4,r6,r8,r10,r12);
	r0->hitPoint = r4;
	r14 = -1;
	r0->lastClickFrame = r14;
	r14 = -1;
	r0->mouseDownButton = r14;
	r15 = false;
	r0->isAbsoluteShape = r15;
	r15 = false;
	r0->allowMultiClick = r15;
	r15 = false;
	r0->enableRightButton = r15;
	r15 = false;
	r0->propagateEvents = r15;
	r15 = false;
	r0->cancelEvents = r15;
	h3d_scene_Object_new(((h3d__scene__Object)r0),r2);
	r0->shape = r1;
	r16 = (venum*)g$hxd_Cursor_Button;
	r16 = h3d_scene_Interactive_set_cursor(r0,r16);
	return;
}
