...
void h3d_scene_MultiMaterial_emit(h3d__scene__MultiMaterial r0,h3d__scene__RenderContext r1) {
	...
	r4 = r5->length;
	label$08e5958_2_4:
	if( r2 >= r4 ) goto label$08e5958_2_33;
	r6 = r2;
	++r2;
	r5 = r0->materials;
	if( r5 == NULL ) hl_null_access();
	...
	label$08e5958_2_17:
	if( !r8 ) goto label$08e5958_2_32;
	if( r8 == NULL ) hl_null_access();
	r11 = r8->passes;
	label$08e5958_2_20:
	if( !r11 ) goto label$08e5958_2_32;
	if( r11 == NULL ) hl_null_access();
	r13 = r11->culled;
	if( r13 ) goto label$08e5958_2_29;
	if( r1 == NULL ) hl_null_access();
	r14 = h3d_scene_RenderContext_emitPass(r1,r11,((h3d__scene__Object)r0));
