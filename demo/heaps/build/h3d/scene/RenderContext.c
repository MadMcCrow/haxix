...
h3d__pass__PassObject h3d_scene_RenderContext_emitPass(h3d__scene__RenderContext r0,h3d__mat__Pass r1,h3d__scene__Object r2) {
	...
	h3d__pass__PassObject r8, r9, r10;
	vdynamic *r12;
	varray *r13;
	int r4, r5;
	...
	r4 = r4 & r5;
	r5 = 0;
	if( r4 != r5 ) goto label$d2e361e_4_11;
	r7 = r0->scene;
	if( r7 == NULL ) hl_null_access();
	r6 = r7->renderer;
	if( r6 == NULL ) hl_null_access();
	h3d_scene_Renderer_setPassFlags(r6,r1);
	label$d2e361e_4_11:
	r8 = r0->allocPool;
	if( r8 ) goto label$d2e361e_4_20;
	r9 = (h3d__pass__PassObject)hl_alloc_obj(&t$h3d_pass_PassObject);
	h3d_pass_PassObject_new(r9);
	r8 = r9;
	r10 = r0->allocFirst;
	r9->nextAlloc = r10;
	r0->allocFirst = r9;
	goto label$d2e361e_4_23;
	label$d2e361e_4_20:
	if( r8 == NULL ) hl_null_access();
	r9 = r8->nextAlloc;
	r0->allocPool = r9;
	...
	r4 = r11->length;
	r5 = r1->passId;
	if( r5 < r4 ) goto label$d2e361e_4_34;
	r11 = r0->passes;
	if( r11 == NULL ) hl_null_access();
	r4 = r1->passId;
	hl_types_ArrayObj_resize(r11,r4);
	label$d2e361e_4_34:
	r11 = r0->passes;
	if( r11 == NULL ) hl_null_access();
	r4 = r1->passId;
	r5 = r11->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$d2e361e_4_41;
	r10 = NULL;
	goto label$d2e361e_4_44;
	label$d2e361e_4_41:
	r13 = r11->array;
	r12 = ((vdynamic**)(r13 + 1))[r4];
	r10 = (h3d__pass__PassObject)r12;
	label$d2e361e_4_44:
	r8->next = r10;
	r11 = r0->passes;
	if( r11 == NULL ) hl_null_access();
	r4 = r1->passId;
	r5 = r11->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$d2e361e_4_51;
	hl_types_ArrayObj___expand(r11,r4);
	label$d2e361e_4_51:
	r13 = r11->array;
	((h3d__pass__PassObject*)(r13 + 1))[r4] = r8;
	return r8;
}
...
void h3d_scene_RenderContext_done(h3d__scene__RenderContext r0) {
	...
	label$d2e361e_8_53:
	r16 = &t$h3d_pass_PassObject;
	r9 = 0;
	r13 = hl_alloc_array(r16,r9);
