...
void h3d_scene_Mesh_draw(h3d__scene__Mesh r0,h3d__scene__RenderContext r1) {
	...
	r4 = r1->engine;
	((void (*)(h3d__prim__Primitive,h3d__Engine))r3->$type->vobj_proto[5])(r3,r4);
	return;
}
...
void h3d_scene_Mesh_emit(h3d__scene__Mesh r0,h3d__scene__RenderContext r1) {
	...
	r4 = r5->passes;
	label$9d0280e_3_4:
	if( !r4 ) goto label$9d0280e_3_16;
	if( r4 == NULL ) hl_null_access();
	r7 = r4->culled;
	if( r7 ) goto label$9d0280e_3_13;
	if( r1 == NULL ) hl_null_access();
	r8 = h3d_scene_RenderContext_emitPass(r1,r4,((h3d__scene__Object)r0));
...
void h3d_scene_Mesh_onAdd(h3d__scene__Mesh r0) {
	...
	((void (*)(h3d__prim__Primitive))r2->$type->vobj_proto[2])(r2);
	label$9d0280e_4_6:
	return;
}
...
h3d__prim__Primitive h3d_scene_Mesh_set_primitive(h3d__scene__Mesh r0,h3d__prim__Primitive r1) {
	...
	r3 = r0->primitive;
	if( r3 == NULL ) hl_null_access();
	((void (*)(h3d__prim__Primitive))r3->$type->vobj_proto[3])(r3);
	label$9d0280e_6_12:
	if( !r1 ) goto label$9d0280e_6_15;
	if( r1 == NULL ) hl_null_access();
	((void (*)(h3d__prim__Primitive))r1->$type->vobj_proto[2])(r1);
	label$9d0280e_6_15:
	r0->primitive = r1;
	return r1;
}
