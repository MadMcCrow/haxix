...
bool h3d_anim_Skin_split(h3d__anim__Skin r0,int r1,hl__types__ArrayBytes_Int r2,hl__types__ArrayBytes_Int r3) {
	...
	*(int*)(r15 + r25) = r18;
	...
	if( r23 == NULL ) hl_null_access();
	r18 = r23->length;
	if( r9 >= r18 ) goto label$2256a37_13_587;
	r18 = r23->length;
	...
	r16 = r35->splitIndex;
	r18 = 0;
	if( r16 >= r18 ) goto label$2256a37_13_586;
	r16 = hl_vfields(r47)[2] ? (*(int*)(hl_vfields(r47)[2])) : (int)hl_dyn_geti(r47->value,-79791526/*priority*/,&t$_i32);
	++r16;
	if( hl_vfields(r47)[2] ) *(int*)(hl_vfields(r47)[2]) = (int)r16; else hl_dyn_seti(r47->value,-79791526/*priority*/,&t$_i32,r16);
	r16 = hl_vfields(r47)[2] ? (*(int*)(hl_vfields(r47)[2])) : (int)hl_dyn_geti(r47->value,-79791526/*priority*/,&t$_i32);
	r18 = 10;
	if( r18 >= r16 ) goto label$2256a37_13_583;
	r51 = (String)s$33f57d7;
	hl_throw((vdynamic*)r51);
	label$2256a37_13_583:
	r49 = true;
	r6 = r49;
	goto label$2256a37_13_587;
	label$2256a37_13_586:
	goto label$2256a37_13_483;
	label$2256a37_13_587:
	if( r6 ) goto label$2256a37_13_589;
	goto label$2256a37_13_590;
	label$2256a37_13_589:
	...
	r0->splitJoints = r34;
	r9 = 0;
	label$2256a37_13_596:
	if( r5 == NULL ) hl_null_access();
	r18 = r5->length;
	if( r9 >= r18 ) goto label$2256a37_13_655;
	r18 = r5->length;
	if( ((unsigned)r9) < ((unsigned)r18) ) goto label$2256a37_13_604;
	r39 = NULL;
	goto label$2256a37_13_607;
	label$2256a37_13_604:
	r10 = r5->array;
	r7 = ((vdynamic**)(r10 + 1))[r9];
	r39 = (h3d__anim___Skin__Permut)r7;
	label$2256a37_13_607:
	++r9;
	r11 = &t$h3d_anim_Joint;
	r16 = 0;
	r10 = hl_alloc_array(r11,r16);
	...
	if( r41 == NULL ) hl_null_access();
	r18 = r41->length;
	label$2256a37_13_617:
	if( r16 >= r18 ) goto label$2256a37_13_646;
	r20 = r16;
	++r16;
	if( r39 == NULL ) hl_null_access();
	r41 = r39->indexedJoints;
	if( r41 == NULL ) hl_null_access();
	r22 = r41->length;
	if( ((unsigned)r20) < ((unsigned)r22) ) goto label$2256a37_13_628;
	r35 = NULL;
	goto label$2256a37_13_631;
	label$2256a37_13_628:
	r10 = r41->array;
	r7 = ((vdynamic**)(r10 + 1))[r20];
	r35 = (h3d__anim__Joint)r7;
	label$2256a37_13_631:
	if( r35 ) goto label$2256a37_13_643;
	r41 = r0->boundJoints;
	if( r41 == NULL ) hl_null_access();
	r21 = 0;
	r22 = r41->length;
	if( ((unsigned)r21) < ((unsigned)r22) ) goto label$2256a37_13_639;
	r36 = NULL;
	goto label$2256a37_13_642;
	label$2256a37_13_639:
	r10 = r41->array;
	r7 = ((vdynamic**)(r10 + 1))[r21];
	r36 = (h3d__anim__Joint)r7;
	label$2256a37_13_642:
	r35 = r36;
	label$2256a37_13_643:
	if( r34 == NULL ) hl_null_access();
	r21 = hl_types_ArrayObj_push(r34,((vdynamic*)r35));
	goto label$2256a37_13_617;
	label$2256a37_13_646:
	r41 = r0->splitJoints;
	if( r41 == NULL ) hl_null_access();
	...
	goto label$2256a37_13_596;
	label$2256a37_13_655:
	r9 = 0;
	r17 = r0->vertexJoints;
	if( r17 == NULL ) hl_null_access();
	r16 = r17->length;
	label$2256a37_13_659:
	if( r9 >= r16 ) goto label$2256a37_13_694;
	r18 = r9;
	++r9;
	r17 = r0->vertexJoints;
	if( r17 == NULL ) hl_null_access();
	...
	if( r44 == NULL ) hl_null_access();
	r22 = r44->length;
	if( ((unsigned)r18) < ((unsigned)r22) ) goto label$2256a37_13_673;
	r21 = 0;
	goto label$2256a37_13_677;
	label$2256a37_13_673:
	r15 = r44->bytes;
	r22 = 2;
	r22 = r18 << r22;
	r21 = *(int*)(r15 + r22);
	label$2256a37_13_677:
	r22 = r34->length;
	if( ((unsigned)r21) < ((unsigned)r22) ) goto label$2256a37_13_681;
	r35 = NULL;
	goto label$2256a37_13_684;
	label$2256a37_13_681:
	r10 = r34->array;
	r7 = ((vdynamic**)(r10 + 1))[r21];
	r35 = (h3d__anim__Joint)r7;
	label$2256a37_13_684:
	if( r35 == NULL ) hl_null_access();
	r21 = r35->splitIndex;
	r22 = r17->length;
	if( ((unsigned)r18) < ((unsigned)r22) ) goto label$2256a37_13_689;
	hl_types_ArrayBytes_Int___expand(r17,r18);
	label$2256a37_13_689:
	r15 = r17->bytes;
	r22 = 2;
	r22 = r18 << r22;
	*(int*)(r15 + r22) = r21;
	goto label$2256a37_13_659;
	label$2256a37_13_694:
	r6 = true;
	return r6;
}
