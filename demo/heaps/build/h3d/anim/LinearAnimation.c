...
void h3d_anim_LinearAnimation_sync(h3d__anim__LinearAnimation r0,bool* r1) {
	...
	h3d__mat__Pass r34;
	h3d__Vector4Impl r29;
	hl__types__ArrayBytes_Float r24;
	double r4, r5, r13, r14, r16, r32, r44, r45, r47, r48, r55, r56, r57, r58, r59, r60, r61, r62, r63, r64, r65, r66, r67;
	h3d__MatrixImpl r53, r54;
	h3d__anim__LinearFrame r51, r52;
	...
	varray *r21;
	int r8, r9, r10, r11, r12, r15, r18, r49, r50, r68, r69;
	...
	r48 = 0.5;
	r47 = r44 - r48;
	if( !(r32 < r47) ) goto label$8608c30_8_234;
	r45 = 1.;
	r32 = r32 + r45;
	...
	r48 = 0.5;
	r47 = r44 + r48;
	if( !(r47 < r32) ) goto label$8608c30_8_239;
	r45 = 1.;
	r32 = r32 - r45;
	label$8608c30_8_239:
	r46 = r36->uvDelta__;
	...
	r49 = r19->length;
	r50 = 1;
	if( r49 != r50 ) goto label$8608c30_8_288;
	r6 = r0->isSync;
	...
	if( r19 == NULL ) hl_null_access();
	r50 = r19->length;
	if( ((unsigned)r15) < ((unsigned)r50) ) goto label$8608c30_8_294;
	r51 = NULL;
	...
	if( r19 == NULL ) hl_null_access();
	r50 = r19->length;
	if( ((unsigned)r18) < ((unsigned)r50) ) goto label$8608c30_8_303;
	r52 = NULL;
	goto label$8608c30_8_306;
	label$8608c30_8_303:
	r21 = r19->array;
	r7 = ((vdynamic**)(r21 + 1))[r18];
	r52 = (h3d__anim__LinearFrame)r7;
	label$8608c30_8_306:
	r53 = r20->matrix;
	...
	r54 = r20->matrix;
	r50 = r19->length;
	if( ((unsigned)r49) < ((unsigned)r50) ) goto label$8608c30_8_566;
	hl_types_ArrayObj___expand(r19,r49);
	label$8608c30_8_566:
	r21 = r19->array;
	((h3d__MatrixImpl*)(r21 + 1))[r49] = r54;
	r23 = r20->targetSkin;
	if( r23 == NULL ) hl_null_access();
	r6 = true;
