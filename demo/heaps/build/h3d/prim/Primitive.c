...
h3d__col__Bounds h3d_prim_Primitive_getBounds(h3d__prim__Primitive r0) {
	String r1, r2;
	r1 = (String)s$not_implemented_for_;
...
void h3d_prim_Primitive_decref(h3d__prim__Primitive r0) {
	...
	r1 = r0->refCount;
	r2 = 0;
	if( r2 < r1 ) goto label$324c01e_5_9;
	r1 = 0;
	r0->refCount = r1;
	((void (*)(h3d__prim__Primitive))r0->$type->vobj_proto[6])(r0);
	label$324c01e_5_9:
	return;
}
...
void h3d_prim_Primitive_render(h3d__prim__Primitive r0,h3d__Engine r1) {
	...
	h3d__Indexes r5;
	r3 = r0->buffer;
	if( !r3 ) goto label$324c01e_8_6;
	r3 = r0->buffer;
	if( r3 == NULL ) hl_null_access();
	r4 = r3->vbuf;
	if( r4 ) goto label$324c01e_8_7;
	label$324c01e_8_6:
	((void (*)(h3d__prim__Primitive,h3d__Engine))r0->$type->vobj_proto[4])(r0,r1);
	label$324c01e_8_7:
	r5 = r0->indexes;
	if( r5 ) goto label$324c01e_8_23;
	r3 = r0->buffer;
	if( r1 == NULL ) hl_null_access();
	r6 = r1->mem;
	...
	if( r3 == NULL ) hl_null_access();
	r7 = r3->vertices;
	r5 = h3d_impl_MemoryManager_getTriIndexes(r6,r7);
	r7 = 3;
	r8 = 0;
	r9 = &r8;
	r10 = -1;
