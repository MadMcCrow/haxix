...
void h3d_Indexes_upload(h3d__Indexes r0,hl__types__ArrayBytes_hl_UI16 r1,int r2,int r3,int* r4) {
	...
	r9 = r0->ibuf;
	((void (*)(h3d__impl__Driver,vvirtual*,int,int,hl__types__ArrayBytes_hl_UI16,int))r7->$type->vobj_proto[32])(r7,r9,r2,r3,r1,r5);
	return;
}
...
void h3d_Indexes_uploadBytes(h3d__Indexes r0,haxe__io__Bytes r1,int r2,int r3) {
	...
	r7 = r0->ibuf;
	r8 = 0;
	((void (*)(h3d__impl__Driver,vvirtual*,int,int,haxe__io__Bytes,int))r5->$type->vobj_proto[33])(r5,r7,r8,r3,r1,r2);
	return;
}
...
h3d__Indexes h3d_Indexes_alloc(hl__types__ArrayBytes_hl_UI16 r0,int* r1,int* r2) {
	...
	h3d__Indexes r8;
	int r3, r4, r6, r7;
	if( r1 ) goto label$366cc49_6_3;
	r3 = 0;
	goto label$366cc49_6_4;
	label$366cc49_6_3:
	r3 = *r1;
	label$366cc49_6_4:
	if( r2 ) goto label$366cc49_6_7;
	r4 = -1;
	goto label$366cc49_6_8;
	label$366cc49_6_7:
	r4 = *r2;
	label$366cc49_6_8:
	r7 = 0;
	if( r4 >= r7 ) goto label$366cc49_6_13;
