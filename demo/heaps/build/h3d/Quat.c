...
void h3d_Quat_initRotateMatrix(h3d__Quat r0,h3d__MatrixImpl r1) {
...
h3d__VectorImpl h3d_Quat_toEuler(h3d__Quat r0) {
	h3d__VectorImpl r1;
	h3d__MatrixImpl r2;
	r2 = NULL;
	r2 = h3d_Quat_toMatrix(r0,r2);
	if( r2 == NULL ) hl_null_access();
	r1 = h3d_MatrixImpl_getEulerAngles(r2);
	return r1;
}

h3d__MatrixImpl h3d_Quat_toMatrix(h3d__Quat r0,h3d__MatrixImpl r1) {
