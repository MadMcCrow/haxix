...
void h3d_pass_Copy_apply(h3d__pass__Copy r0,h3d__mat__Texture r1,h3d__mat__Texture r2,venum* r3,h3d__mat__Pass r4,vdynamic* r5) {
	h3d__shader__ScreenShader r13;
	venum *r12, *r16;
	h3d__Engine r8;
	hxsl__ShaderList r17, r18, r19;
	h3d__mat__Pass r15;
	int *r10, *r11;
	h3d__pass___Copy__CopyShader r14;
	int r9;
	h3d__mat__Texture r7;
	if( !r2 ) goto label$99e63e8_2_11;
	...
	r11 = NULL;
	r12 = NULL;
	h3d_Engine_pushTarget(r8,r2,r10,r11,r12);
	label$99e63e8_2_11:
	r13 = r0->shader;
	r14 = (h3d__pass___Copy__CopyShader)r13;
	if( r14 == NULL ) hl_null_access();
	r14->texture__ = r1;
	if( !r4 ) goto label$99e63e8_2_39;
	if( !r3 ) goto label$99e63e8_2_19;
	if( r4 == NULL ) hl_null_access();
	h3d_mat_Pass_setBlendMode(r4,r3);
	label$99e63e8_2_19:
	if( r4 == NULL ) hl_null_access();
	r17 = r4->shaders;
	label$99e63e8_2_21:
	...
	r18 = r17->next;
	if( !r18 ) goto label$99e63e8_2_28;
	r18 = r17->next;
	r17 = r18;
	goto label$99e63e8_2_21;
	label$99e63e8_2_28:
	r15 = r0->pass;
	...
	r19 = NULL;
	r17->next = r19;
	goto label$99e63e8_2_47;
	label$99e63e8_2_39:
	r15 = r0->pass;
	if( r15 == NULL ) hl_null_access();
	if( r3 ) goto label$99e63e8_2_44;
	r16 = (venum*)g$h2d_BlendMode_None;
	goto label$99e63e8_2_45;
	label$99e63e8_2_44:
	r16 = r3;
	label$99e63e8_2_45:
	h3d_mat_Pass_setBlendMode(r15,r16);
	h3d_pass_ScreenFx_render(((h3d__pass__ScreenFx)r0));
	label$99e63e8_2_47:
	r13 = r0->shader;
	r14 = (h3d__pass___Copy__CopyShader)r13;
