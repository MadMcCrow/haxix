...
void h3d_pass_ScreenFx_new(h3d__pass__ScreenFx r0,h3d__shader__ScreenShader r1,hl__types__ArrayObj r2) {
	...
	bool r11;
	hxsl__ShaderList r7, r8;
	h3d__mat__Pass r5, r9;
	r0->shader = r1;
	r3 = (h3d__pass__ShaderManager)hl_alloc_obj(&t$h3d_pass_ShaderManager);
	h3d_pass_ShaderManager_new(r3,r2);
	r0->manager = r3;
	r5 = (h3d__mat__Pass)hl_alloc_obj(&t$h3d_mat_Pass);
	r6 = (String)s$screenfx;
	r7 = (hxsl__ShaderList)hl_alloc_obj(&t$hxsl_ShaderList);
	r8 = NULL;
	hxsl_ShaderList_new(r7,((hxsl__Shader)r1),r8);
	r9 = NULL;
	h3d_mat_Pass_new(r5,r6,r7,r9);
	r0->pass = r5;
	r5 = r0->pass;
	if( r5 == NULL ) hl_null_access();
	r10 = (venum*)g$h3d_mat_Face_None;
	r10 = h3d_mat_Pass_set_culling(r5,r10);
	r5 = r0->pass;
	if( r5 == NULL ) hl_null_access();
	r11 = false;
	r12 = (venum*)g$h3d_mat_Compare_Always;
	h3d_mat_Pass_depth(r5,r11,r12);
	return;
}
...
void h3d_pass_ScreenFx_render(h3d__pass__ScreenFx r0) {
	...
	r15 = NULL;
	r13 = h3d_pass_ShaderManager_compileShaders(r14,r11,r15);
	r8 = h3d_pass_ScreenFx_get_engine(r0);
	if( r8 == NULL ) hl_null_access();
	r12 = r0->pass;
	h3d_Engine_selectMaterial(r8,r12);
	r8 = h3d_pass_ScreenFx_get_engine(r0);
	if( r8 == NULL ) hl_null_access();
	h3d_Engine_selectShader(r8,r13);
	r16 = r0->buffers;
	if( r16 ) goto label$c8a443f_3_42;
	r16 = (h3d__shader__Buffers)hl_alloc_obj(&t$h3d_shader_Buffers);
	h3d_shader_Buffers_new(r16,r13);
	r0->buffers = r16;
	goto label$c8a443f_3_53;
	label$c8a443f_3_42:
	r16 = r0->buffers;
	...
	if( r14 == NULL ) hl_null_access();
	r16 = r0->buffers;
	h3d_pass_ShaderManager_fillGlobals(r14,r16,r13);
	r14 = r0->manager;
	if( r14 == NULL ) hl_null_access();
	r16 = r0->buffers;
	h3d_pass_ShaderManager_fillParams(r14,r16,r13,r11);
	r8 = h3d_pass_ScreenFx_get_engine(r0);
	if( r8 == NULL ) hl_null_access();
	r16 = r0->buffers;
	r19 = 0;
	...
	r8 = h3d_pass_ScreenFx_get_engine(r0);
	((void (*)(h3d__prim__Primitive,h3d__Engine))r2->$type->vobj_proto[5])(r2,r8);
	return;
}
