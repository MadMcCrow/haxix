...
haxe__MainEvent haxe_MainLoop_add(vclosure* r0,int* r1) {
	...
	r2 = *r1;
	label$1c38f5c_2_4:
	if( r0 ) goto label$1c38f5c_2_7;
	r4 = (String)s$Event_function_is_null;
	hl_throw((vdynamic*)r4);
	label$1c38f5c_2_7:
	r5 = (haxe__MainEvent)hl_alloc_obj(&t$haxe_MainEvent);
	haxe_MainEvent_new(r5,r0,r2);
	r7 = (haxe__$MainLoop)g$_haxe_MainLoop;
	r6 = r7->pending;
	if( !r6 ) goto label$1c38f5c_2_14;
