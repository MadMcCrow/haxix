...
hl__types__ArrayObj haxe__CallStack_CallStack_Impl__callStack() {
	...
	r4 = &t$hl_symbol;
	r1 = hl_alloc_array(r4,r0);
	r3 = hl_call_stack_raw(r1);
	r3 = r1->size;
	r6 = 0;
	if( r3 != r6 ) goto label$e26c8ce_1_10;
	r5 = r1;
	goto label$e26c8ce_1_19;
	label$e26c8ce_1_10:
	r3 = r1->size;
	r6 = 1;
	r3 = r3 - r6;
	r4 = &t$hl_symbol;
	r7 = hl_alloc_array(r4,r3);
	r6 = 0;
	r8 = 1;
	hl_array_blit(r7,r6,r1,r8,r3);
	r5 = r7;
	label$e26c8ce_1_19:
	r10 = NULL;
	r9 = haxe_NativeStackTrace_toHaxe(r5,r10);
	return r9;
}
